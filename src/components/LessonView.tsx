    ...
    <div className="space-y-4 sm:space-y-5">
      ...
      <div className="grid grid-cols-4 gap-1 p-1 bg-zinc-100 dark:bg-zinc-800/70 rounded-2xl border border-zinc-200 dark:border-zinc-700/60">
        <button
          ...
          className={`py-2 px-1 sm:px-2.5 rounded-xl font-semibold text-xs sm:text-sm flex items-center justify-center gap-1 transition ${
            activeTab === 'theory'
        ...
        >
          ...
          <span className="truncate">Словарь <span className="text-[10px] opacity-75">({lesson.vocabulary.length})</span></span>
