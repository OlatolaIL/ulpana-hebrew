    ...
    <div className="bg-white dark:bg-zinc-900 rounded-3xl p-6 border border-zinc-200 dark:border-zinc-800 shadow-lg space-y-6">
      <div className="text-center py-4">
        ...
        <p className="text-xs text-zinc-400 mt-3">
          Нажмите, чтобы прослушать слово еще раз
        </p>
      </div>
        ...
        {quizOptions.map((opt, i) => {
          ...
          return (
            <button
              ...
              dir="ltr"
              className={`p-3.5 rounded-xl border text-sm transition cursor-pointer text-left ${btnClass}`}
            >
              {opt}
            </button>
          );
      ...
      <div className="flex items-center justify-between pt-2 border-t border-zinc-100 dark:border-zinc-800">
        ...
        <button
          ...
          title="Перейти к следующему слову"
        >
          <span>Пропустить (далее)</span>
