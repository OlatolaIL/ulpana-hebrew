...
export const HEBREW_ALPHABET: HebrewLetter[] = [
  ...
  },
  {
    ...
    "sound": "Мягкий придыхательный звук [h], как в украинском «г» или английском «h».",
    "gematria": 5,
  ...
  },
  {
    ...
    "nameRussian": "Пей / Фей",
    "transcription": "п / ф",
    "sound": "С точкой (дагеш) — [П], без точки — [Ф].",
    "gematria": 80,
  ...
  },
  {
    ...
    "nameRussian": "Коф",
    "transcription": "к",
    "sound": "Твердый согласный звук [К].",
    "gematria": 100,
