...
export const HEALTH_DECKS: ThematicDeck[] = [
  ...
  // ==========================================
  {
    ...
    words: [
      ...
      { id: 'b_alef_30', hebrew: 'עָיֵיף', hebrewPlain: 'עייף', transcription: 'айéф', translation: 'уставший', partOfSpeech: 'adjective', lessonId: 0 },
      { id: 'b_alef_31', hebrew: 'עֲיֵיפָה', hebrewPlain: 'עייפה', transcription: 'айефá', translation: 'уставшая', partOfSpeech: 'adjective', lessonId: 0 },
  ...
  // ==========================================
  {
    ...
    icon: 'Stethoscope',
    words: [
      { id: 'm_bet_1', hebrew: 'קוּפַּת חוֹלִים', hebrewPlain: 'קופת חולים', transcription: 'купáт холӣм', translation: 'больничная касса (Клалит, Маккаби, Меухедет, Леумит)', partOfSpeech: 'noun', lessonId: 0 },
      ...
      { id: 'm_bet_3', hebrew: 'לִקְבּוֹעַ תּוֹר', hebrewPlain: 'לקבוע תור', transcription: 'ликбóа тор', translation: 'записаться на прием к врачу', partOfSpeech: 'expression', lessonId: 0 },
      ...
      { id: 'm_bet_5', hebrew: 'רוֹפֵא מוּמְחֶה', hebrewPlain: 'רופא מומחה', transcription: 'рофé мумхé', translation: 'врач-специалист (узкий профиль)', partOfSpeech: 'noun', lessonId: 0 },
      ...
      { id: 'm_bet_10', hebrew: 'בִּיטּוּחַ רְפוּאִי', hebrewPlain: 'ביטוח רפואי', transcription: 'битӯах рефу’ӣ', translation: 'медицинская страховка', partOfSpeech: 'noun', lessonId: 0 },
      { id: 'm_bet_11', hebrew: 'חֲדַר מִיּוּן', hebrewPlain: 'חדר מיון', transcription: 'хадáр мийӯн', translation: 'приемный покой в больнице (ER)', partOfSpeech: 'noun', lessonId: 0 },
      ...
      { id: 'm_bet_14', hebrew: 'חִיסּוּן', hebrewPlain: 'חיסון', transcription: 'хисӯн', translation: 'прививка, вакцинация', partOfSpeech: 'noun', lessonId: 0 },
