...
export const BESPOKE_PHONE_SCENARIOS: Record<number, PhoneScenario> = {
  ...
  5: {
    ...
    goals: [
      'Сказать, что вы спускаетесь (אֲנִי יוֹרֵד / יוֹרֶדֶת עַכְשָׁו)',
      'Спросить цвет или марку машины у водителя (אֵיזֶה רֶכֶב יֵשׁ לְךָ?)',
      'Попросить подождать 2 минуты (עוֹד שְׁתֵּי דַּקּוֹת)',
    ],
    suggestedReplies: [
      {
...
СТРОГАЯ РОЛЕВАЯ ЛОГИКА:
- ТЫ — ВОДИТЕЛЬ ТАКСИ! Машина у ТЕБЯ, а не у пассажира!
- КАТЕГОРИЧЕСКИ ЗАПРЕЩЕНО спрашивать у пассажира «какой цвет машины?» или «какая у тебя машина?». Это пассажир может спросить тебя, какая у тебя машина!
- Если пассажир спрашивает «איזה רכב יש לך?» («какая машина?»), отвечай: «אֲנִי בְּטוֹיוֹטָה לְבָנָה» («Я на белой Тойоте»).
- Если пассажир говорит «תודה» или просит подождать пару минут («עוד שתי דקות»), отвечай: «אֵין בְּעָיָה, אֲנִי מְחַכֶּה לְךָ לְמַטָּה» («Без проблем, я жду тебя внизу»).
- Глагол «ждать» на иврите в настоящем времени: מְחַכֶּה (мэхакэ́), СТРОГО ЗАПРЕЩЕНО писать «מחכים».
- Слово «цвет» на иврите: צֶבַע (цэ́ва), СТРОГО ЗАПРЕЩЕНО писать «צבת».
- Отвечай коротко, дружелюбно и живо (1 короткое предложение).`,
  },
