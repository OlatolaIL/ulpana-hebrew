...
export const CAREGIVER_DECKS: ThematicDeck[] = [
  ...
  // ==========================================
  {
    ...
    words: [
      ...
      { id: 'cg_v_3', hebrew: 'לִשְׁטוֹף', hebrewPlain: 'לשטוף', transcription: 'лиштóф', translation: 'мыть, полоскать', partOfSpeech: 'verb', root: 'ש-ט-ף', lessonId: 0 },
      ...
      { id: 'cg_v_10', hebrew: 'לְסַיֵּיעַ', hebrewPlain: 'לסייע', transcription: 'лесайéа', translation: 'помогать, оказывать содействие', partOfSpeech: 'verb', root: 'ס-י-ע', lessonId: 0 },
      { id: 'cg_v_11', hebrew: 'לִתְמוֹךְ', hebrewPlain: 'לתמוך', transcription: 'литмóх', translation: 'поддерживать (физически)', partOfSpeech: 'verb', root: 'ת-מ-ך', lessonId: 0 },
      ...
      // --- МЕДИЦИНСКИЕ ГЛАГОЛЫ ---
      { id: 'cg_v_14', hebrew: 'לִמְדוֹד', hebrewPlain: 'למדוד', transcription: 'лимдóд', translation: 'измерять', partOfSpeech: 'verb', root: 'מ-ד-ד', lessonId: 0 },
      { id: 'cg_v_15', hebrew: 'לִבְדּוֹק', hebrewPlain: 'לבדוק', transcription: 'ливдóк', translation: 'проверять, осматривать', partOfSpeech: 'verb', root: 'ב-ד-ק', lessonId: 0 },
      ...
      { id: 'cg_v_17', hebrew: 'לָתֵת תְּרוּפָה', hebrewPlain: 'לתת תרופה', transcription: 'латéт трýфа', translation: 'дать лекарство', partOfSpeech: 'verb', root: 'נ-ת-ן', lessonId: 0 },
      ...
      { id: 'cg_v_22', hebrew: 'לְדַוֵּוחַ', hebrewPlain: 'לדווח', transcription: 'ледавéах', translation: 'сообщать, докладывать', partOfSpeech: 'verb', root: 'ד-ו-ח', lessonId: 0 },
