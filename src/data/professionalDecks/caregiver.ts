...
export const CAREGIVER_DECKS: ThematicDeck[] = [
  ...
  // ==========================================
  {
    ...
    words: [
      ...
      { id: 'cg_v_1', hebrew: 'לְטַפֵּל', hebrewPlain: 'לטפל', transcription: 'летапéль', translation: 'ухаживать, лечить', partOfSpeech: 'verb', root: 'ט-פ-ל', lessonId: 23 },
      { id: 'cg_v_2', hebrew: 'לְרַחֵץ', hebrewPlain: 'לרחץ', transcription: 'лерахéц', translation: 'мыть, купать (кого-то)', partOfSpeech: 'verb', root: 'ר-ח-ץ', lessonId: 7 },
      { id: 'cg_v_3', hebrew: 'לִשְׁטוֹף', hebrewPlain: 'לשטוף', transcription: 'лиштóф', translation: 'мыть, полоскать', partOfSpeech: 'verb', root: 'ש-ט-ף', lessonId: 7 },
      { id: 'cg_v_4', hebrew: 'לְהַלְבִּישׁ', hebrewPlain: 'להלביש', transcription: 'лехальбíш', translation: 'одевать (кого-то)', partOfSpeech: 'verb', root: 'ל-ב-ש', lessonId: 12 },
      { id: 'cg_v_5', hebrew: 'לְהַפְשִׁיט', hebrewPlain: 'להפשיט', transcription: 'лехафшíт', translation: 'раздевать (кого-то)', partOfSpeech: 'verb', root: 'פ-ש-ט', lessonId: 12 },
      { id: 'cg_v_6', hebrew: 'לְהַאֲכִיל', hebrewPlain: 'להאכיל', transcription: 'лехаахиль', translation: 'кормить (кого-то)', partOfSpeech: 'verb', root: 'א-כ-ל', lessonId: 17 },
      { id: 'cg_v_7', hebrew: 'לְהַשְׁקוֹת', hebrewPlain: 'להשקות', transcription: 'лехашкóт', translation: 'поить (кого-то)', partOfSpeech: 'verb', root: 'ש-ק-ה', lessonId: 2 },
      { id: 'cg_v_8', hebrew: 'לְהַשְׁכִּיב', hebrewPlain: 'להשכיב', transcription: 'лехашкíв', translation: 'укладывать (спать)', partOfSpeech: 'verb', root: 'ש-כ-ב', lessonId: 9 },
      { id: 'cg_v_9', hebrew: 'לְהַעֲמִיד', hebrewPlain: 'להעמיד', transcription: 'лехаамíд', translation: 'поднимать на ноги, ставить', partOfSpeech: 'verb', root: 'ע-מ-ד', lessonId: 9 },
      { id: 'cg_v_10', hebrew: 'לְסַיֵּיעַ', hebrewPlain: 'לסייע', transcription: 'лесайéа', translation: 'помогать, оказывать содействие', partOfSpeech: 'verb', root: 'ס-י-ע', lessonId: 89 },
      { id: 'cg_v_11', hebrew: 'לִתְמוֹךְ', hebrewPlain: 'לתמוך', transcription: 'литмóх', translation: 'поддерживать (физически)', partOfSpeech: 'verb', root: 'ת-מ-ך', lessonId: 23 },
      { id: 'cg_v_12', hebrew: 'לְסַדֵּר', hebrewPlain: 'לסדר', transcription: 'лесадéр', translation: 'приводить в порядок, убирать', partOfSpeech: 'verb', root: 'ס-ד-ר', lessonId: 7 },
      { id: 'cg_v_13', hebrew: 'לְחַמֵּם', hebrewPlain: 'לחמם', transcription: 'лехамéм', translation: 'разогревать, согревать', partOfSpeech: 'verb', root: 'ח-מ-מ', lessonId: 17 },
      // --- МЕДИЦИНСКИЕ ГЛАГОЛЫ ---
      { id: 'cg_v_14', hebrew: 'לִמְדוֹד', hebrewPlain: 'למדוד', transcription: 'лимдóд', translation: 'измерять', partOfSpeech: 'verb', root: 'מ-ד-ד', lessonId: 23 },
      { id: 'cg_v_15', hebrew: 'לִבְדּוֹק', hebrewPlain: 'לבדוק', transcription: 'ливдóк', translation: 'проверять, осматривать', partOfSpeech: 'verb', root: 'ב-ד-ק', lessonId: 23 },
      { id: 'cg_v_16', hebrew: 'לְטַפֵּל בְּ', hebrewPlain: 'לטפל ב', transcription: 'летапéль бе', translation: 'ухаживать за (кем-то)', partOfSpeech: 'verb', root: 'ט-פ-ל', lessonId: 23 },
      { id: 'cg_v_17', hebrew: 'לָתֵת תְּרוּפָה', hebrewPlain: 'לתת תרופה', transcription: 'латéт трýфа', translation: 'дать лекарство', partOfSpeech: 'verb', root: 'נ-ת-ן', lessonId: 46 },
      { id: 'cg_v_18', hebrew: 'לְשַׁכֵּךְ', hebrewPlain: 'לשכך', transcription: 'лешакéх', translation: 'облегчать (боль)', partOfSpeech: 'verb', root: 'ש-כ-ך', lessonId: 46 },
      { id: 'cg_v_19', hebrew: 'לְהַרְגִּיעַ', hebrewPlain: 'להרגיע', transcription: 'лехаргíа', translation: 'успокаивать', partOfSpeech: 'verb', root: 'ר-ג-ע', lessonId: 16 },
      { id: 'cg_v_20', hebrew: 'לְהַחְזִיר', hebrewPlain: 'להחזיר', transcription: 'лехахзíр', translation: 'вернуть, положить обратно', partOfSpeech: 'verb', root: 'ח-ז-ר', lessonId: 7 },
      { id: 'cg_v_21', hebrew: 'לְהַזְמִין', hebrewPlain: 'להזמין', transcription: 'лехазмíн', translation: 'заказать, пригласить (врача)', partOfSpeech: 'verb', root: 'ז-מ-ן', lessonId: 46 },
      { id: 'cg_v_22', hebrew: 'לְדַוֵּוחַ', hebrewPlain: 'לדווח', transcription: 'ледавéах', translation: 'сообщать, докладывать', partOfSpeech: 'verb', root: 'ד-ו-ח', lessonId: 46 },
      { id: 'cg_v_23', hebrew: 'לְהַחְלִיף', hebrewPlain: 'להחליף', transcription: 'лехахлíф', translation: 'менять (памперс, постель)', partOfSpeech: 'verb', root: 'ח-ל-ף', lessonId: 7 },
      { id: 'cg_v_24', hebrew: 'לְעוֹדֵד', hebrewPlain: 'לעודד', transcription: 'леодéд', translation: 'ободрять, поддерживать', partOfSpeech: 'verb', root: 'ע-ד-ד', lessonId: 16 },
      { id: 'cg_v_25', hebrew: 'לְלַווֹת', hebrewPlain: 'ללוות', transcription: 'лелавóт', translation: 'сопровождать', partOfSpeech: 'verb', root: 'ל-ו-ה', lessonId: 6 },
    ],
  },
  ...
  // ==========================================
  {
    ...
    words: [
      ...
      { id: 'cg_b_2', hebrew: 'יָד', hebrewPlain: 'יד', transcription: 'яд', translation: 'рука', partOfSpeech: 'noun', gender: 'f', plural: 'יָדַיִּים', lessonId: 0 },
      { id: 'cg_b_3', hebrew: 'רֶגֶל', hebrewPlain: 'רגל', transcription: 'рéгель', translation: 'нога', partOfSpeech: 'noun', gender: 'f', plural: 'רַגְלַיִּים', lessonId: 0 },
      ...
      { id: 'cg_b_15', hebrew: 'חוֹם', hebrewPlain: 'חום', transcription: 'хом', translation: 'температура, жар', partOfSpeech: 'noun', gender: 'm', lessonId: 0 },
      ...
      { id: 'cg_b_17', hebrew: 'סְחַרְחוֹרֶת', hebrewPlain: 'סחרחורת', transcription: 'схархóрет', translation: 'головокружение', partOfSpeech: 'noun', gender: 'f', lessonId: 0 },
  ...
  // ==========================================
  {
    ...
    words: [
      ...
      { id: 'cg_d_4', hebrew: 'מִשְׁחַת שִׁינַּיִים', hebrewPlain: 'משחת שיניים', transcription: 'мишхат шинайím', translation: 'зубная паста', partOfSpeech: 'noun', gender: 'f', lessonId: 0 },
      { id: 'cg_d_5', hebrew: 'מִיטוּשׁ', hebrewPlain: 'מיטוש', transcription: 'митýш', translation: 'подгузник, памперс', partOfSpeech: 'noun', gender: 'm', lessonId: 0 },
      ...
      { id: 'cg_d_8', hebrew: 'מִיטָּה', hebrewPlain: 'מיטה', transcription: 'митá', translation: 'кровать', partOfSpeech: 'noun', gender: 'f', lessonId: 0 },
  ...
  // ==========================================
  {
    ...
    words: [
      ...
      { id: 'cg_m_4', hebrew: 'טִיפּוֹת', hebrewPlain: 'טיפות', transcription: 'типóт', translation: 'капли', partOfSpeech: 'noun', gender: 'f', lessonId: 0 },
      ...
      { id: 'cg_m_7', hebrew: 'מִינּוּן', hebrewPlain: 'מינון', transcription: 'минун', translation: 'дозировка, доза', partOfSpeech: 'noun', gender: 'm', lessonId: 0 },
      ...
      // --- РАСПИСАНИЕ ---
      { id: 'cg_m_17', hebrew: 'בַּבּוֹקֶר', hebrewPlain: 'בבוקר', transcription: 'бабóкер', translation: 'утром', partOfSpeech: 'adverb', lessonId: 0 },
      { id: 'cg_m_18', hebrew: 'בַּצָּהֳרַיִּים', hebrewPlain: 'בצהריים', transcription: 'бацахорáим', translation: 'в обед, днём', partOfSpeech: 'adverb', lessonId: 0 },
  ...
  // ==========================================
  {
    ...
    words: [
      ...
      { id: 'cg_t_7', hebrew: 'עַכְשָׁיו נֹאכַל', hebrewPlain: 'עכשיו נאכל', transcription: 'ахшáв неехáль', translation: 'Сейчас поедим', partOfSpeech: 'expression', lessonId: 0 },
      { id: 'cg_t_8', hebrew: 'אֲנִי אֲסַיֵּיעַ לְךָ', hebrewPlain: 'אני אסייע לך', transcription: 'ани асайéа лехá', translation: 'Я тебе помогу', partOfSpeech: 'expression', lessonId: 0 },
      ...
      { id: 'cg_t_10', hebrew: 'הַכּוֹל בְּסֵדֶר', hebrewPlain: 'הכל בסדר', transcription: 'хаколь бесéдер', translation: 'Всё в порядке', partOfSpeech: 'expression', lessonId: 0 },
      ...
      { id: 'cg_t_25', hebrew: 'מָגֵן דָּוִד אָדוֹם', hebrewPlain: 'מגן דוד אדום', transcription: 'магéн давид адóм', translation: 'скорая помощь (Маген Давид)', partOfSpeech: 'noun', gender: 'm', lessonId: 0 },
    ],
  },
];
