...
export const MOM_DECKS: ThematicDeck[] = [
  ...
  // ==========================================
  {
    ...
    words: [
      ...
      { id: 'mom_ped_7', hebrew: 'דַּלֶּקֶת אוֹזְנַיִם', hebrewPlain: 'דלקת אוזניים', transcription: 'далéкет ознáим', translation: 'отит, воспаление уха', partOfSpeech: 'noun', gender: 'f', lessonId: 0 },
  ...
  // ==========================================
  {
    ...
    words: [
      ...
      { id: 'mom_phm_12', hebrew: 'טִיפּוֹת אוֹזְנַיִם', hebrewPlain: 'טיפות אוזניים', transcription: 'типóт ознáим', translation: 'ушные капли', partOfSpeech: 'noun', gender: 'f', lessonId: 0 },
