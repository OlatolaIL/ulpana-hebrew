...
export const KINDERGARTEN_DECKS: ThematicDeck[] = [
  ...
  // ==========================================
  {
    ...
    icon: 'Baby',
    words: [
      { id: 'kg_v_1', hebrew: 'לְהַשְׁגִּיחַ', hebrewPlain: 'להשגיח', transcription: 'леhашгӣах', translation: 'присматривать, следить за детьми', partOfSpeech: 'verb', root: 'ש-ג-ח', lessonId: 40 },
      { id: 'kg_v_2', hebrew: 'לְחַבֵּק', hebrewPlain: 'לחבק', transcription: 'лехабéк', translation: 'обнимать', partOfSpeech: 'verb', root: 'ח-ב-ק', lessonId: 11 },
      { id: 'kg_v_3', hebrew: 'לְהַרְגִּיעַ', hebrewPlain: 'להרגיע', transcription: 'леhаргӣа', translation: 'успокаивать', partOfSpeech: 'verb', root: 'ר-ג-ע', lessonId: 16 },
      { id: 'kg_v_4', hebrew: 'לְנַחֵם', hebrewPlain: 'לנחם', transcription: 'ленахéм', translation: 'утешать', partOfSpeech: 'verb', root: 'נ-ח-ם', lessonId: 16 },
      { id: 'kg_v_5', hebrew: 'לְשַׁתֵּף', hebrewPlain: 'לשתף', transcription: 'лешатéф', translation: 'делиться, вовлекать в игру', partOfSpeech: 'verb', root: 'ש-ת-ף', lessonId: 33 },
      { id: 'kg_v_6', hebrew: 'לְצַיֵּיר', hebrewPlain: 'לצייר', transcription: 'лецайéр', translation: 'рисовать', partOfSpeech: 'verb', root: 'צ-י-ר', lessonId: 25 },
      { id: 'kg_v_7', hebrew: 'לִגְזוֹר', hebrewPlain: 'לגזור', transcription: 'лигзóр', translation: 'вырезать (ножницами)', partOfSpeech: 'verb', root: 'ג-ז-ר', lessonId: 33 },
      { id: 'kg_v_8', hebrew: 'לְהַדְבִּיק', hebrewPlain: 'להדביק', transcription: 'леhадбӣк', translation: 'наклеивать, клеить', partOfSpeech: 'verb', root: 'ד-ב-ק', lessonId: 33 },
      { id: 'kg_v_9', hebrew: 'לְהַרְכִּיב', hebrewPlain: 'להרכיב', transcription: 'леhаркӣв', translation: 'собирать (пазл, конструктор)', partOfSpeech: 'verb', root: 'ר-כ-ב', lessonId: 33 },
      { id: 'kg_v_10', hebrew: 'לְהַקְרִיא', hebrewPlain: 'להקריא', transcription: 'леhакрӣ', translation: 'читать вслух (сказку, книжку)', partOfSpeech: 'verb', root: 'ק-ר-א', lessonId: 8 },
      { id: 'kg_v_11', hebrew: 'לִשְׁכַּב', hebrewPlain: 'לשכב', transcription: 'лишкáв', translation: 'ложиться (на тихий час)', partOfSpeech: 'verb', root: 'ש-כ-ב', lessonId: 9 },
      { id: 'kg_v_12', hebrew: 'לְהֵירָדֵם', hebrewPlain: 'להירדם', transcription: 'леhерадéм', translation: 'засыпать', partOfSpeech: 'verb', root: 'ר-ד-ם', lessonId: 9 },
      { id: 'kg_v_13', hebrew: 'לְהַלְבִּישׁ', hebrewPlain: 'להלביש', transcription: 'леhальбӣш', translation: 'одевать ребёнка', partOfSpeech: 'verb', root: 'ל-ב-ש', lessonId: 12 },
      { id: 'kg_v_14', hebrew: 'לִנְעוֹל', hebrewPlain: 'לנעול', transcription: 'линъóль', translation: 'обувать (ботинки, сандалии)', partOfSpeech: 'verb', root: 'נ-ע-ל', lessonId: 12 },
      { id: 'kg_v_15', hebrew: 'לְהַחְלִיף חִיתּוּל', hebrewPlain: 'להחליף חיתול', transcription: 'леhахлӣф хитӯль', translation: 'менять подгузник', partOfSpeech: 'verb', root: 'ח-ל-ף', lessonId: 11 },
      { id: 'kg_v_16', hebrew: 'לִרְחוֹץ יָדַיִּים', hebrewPlain: 'לרחוץ ידיים', transcription: 'лирхóц ядáим', translation: 'мыть руки', partOfSpeech: 'verb', root: 'ר-ח-ץ', lessonId: 7 },
      { id: 'kg_v_17', hebrew: 'לְסַדֵּר מִשְׂחָקִים', hebrewPlain: 'לסדר משחקים', transcription: 'лесадéр мисхакӣм', translation: 'убирать игрушки', partOfSpeech: 'verb', root: 'ס-ד-ר', lessonId: 7 },
      { id: 'kg_v_18', hebrew: 'לְוַותֵּר', hebrewPlain: 'לוותר', transcription: 'леватéр', translation: 'уступать (очередь, игрушку)', partOfSpeech: 'verb', root: 'ו-ת-ר', lessonId: 40 },
      { id: 'kg_v_19', hebrew: 'לְבַקֵּשׁ סְלִיחָה', hebrewPlain: 'לבקש סליחה', transcription: 'левакéш слихá', translation: 'просить прощения, извиняться', partOfSpeech: 'verb', root: 'ב-ק-ש', lessonId: 1 },
      { id: 'kg_v_20', hebrew: 'לְחַלֵּק', hebrewPlain: 'לחלק', transcription: 'лехалéк', translation: 'раздавать (еду, листы, карандаши)', partOfSpeech: 'verb', root: 'ח-ל-ק', lessonId: 40 },
      { id: 'kg_v_21', hebrew: 'לְהִתְנַהֵג', hebrewPlain: 'להתנהג', transcription: 'леhитнаhéг', translation: 'вести себя', partOfSpeech: 'verb', root: 'נ-ה-ג', lessonId: 83 },
      { id: 'kg_v_22', hebrew: 'לִשְׁמוֹר עַל כְּלָלִים', hebrewPlain: 'לשמור על כללים', transcription: 'лишмóр аль клалӣм', translation: 'соблюдать правила', partOfSpeech: 'verb', root: 'ש-מ-ר', lessonId: 40 },
      { id: 'kg_v_23', hebrew: 'לָשִׁיר', hebrewPlain: 'לשיר', transcription: 'лашӣр', translation: 'петь (песенки)', partOfSpeech: 'verb', root: 'ש-י-ר', lessonId: 33 },
      { id: 'kg_v_24', hebrew: 'לִרְקוֹד', hebrewPlain: 'לרקוד', transcription: 'лиркóд', translation: 'танцевать', partOfSpeech: 'verb', root: 'ר-ק-ד', lessonId: 33 },
      { id: 'kg_v_25', hebrew: 'לִגְמוֹל', hebrewPlain: 'לגמול', transcription: 'лигмóль', translation: 'приучать к горшку / отучать от соски', partOfSpeech: 'verb', root: 'ג-מ-ל', lessonId: 40 },
    ],
  },
  ...
  // ==========================================
  {
    ...
    words: [
      ...
      { id: 'kg_p_5', hebrew: 'לֹא לְהַרְבִּיץ, מְדַבְּרִים בְּמִילִּים', hebrewPlain: 'לא להרביץ, מדברים במילים', transcription: 'ло леhарбӣц, медабрӣм бемйлӣм', translation: 'Не драться! Мы говорим словами', partOfSpeech: 'expression', lessonId: 0 },
      ...
      { id: 'kg_p_7', hebrew: 'אַל תִּדְאַג, אִמָּא תָּבוֹא בְּאַרְבַּע', hebrewPlain: 'אל תדאג, אמא תבוא בארבע', transcription: 'аль тид’áг, ӣма тавó беáрба', translation: 'Не волнуйся, мама придёт в четыре', partOfSpeech: 'expression', lessonId: 0 },
      ...
      { id: 'kg_p_9', hebrew: 'עַכְשָׁיו אוֹסְפִים אֶת הַמִּשְׂחָקִים', hebrewPlain: 'עכשיו אוספים את המשחקים', transcription: 'ахшáв осфӣм эт hамисхакӣм', translation: 'А сейчас собираем игрушки!', partOfSpeech: 'expression', lessonId: 0 },
      ...
      { id: 'kg_p_11', hebrew: 'כָּל הַכָּבוֹד, אֵיזֶה יוֹפִי!', hebrewPlain: 'כל הכבוד, איזה יופי!', transcription: 'коль hакавóд, éйзе йóфи!', translation: 'Молодец, какая красота!', partOfSpeech: 'expression', lessonId: 0 },
      { id: 'kg_p_12', hebrew: 'בּוֹא נְנַגֵּב אֶת הַדְּמָעוֹת', hebrewPlain: 'בוא ננגב את הדמעות', transcription: 'бо ненагéв эт hадмаóт', translation: 'Давай вытрем слёзки', partOfSpeech: 'expression', lessonId: 0 },
      { id: 'kg_p_13', hebrew: 'חִיבּוּק גָּדוֹל וְהַכּוֹל עוֹבֵר', hebrewPlain: 'חיבוק גדול והכול עובר', transcription: 'хибӯк гадóль веhакóль овéр', translation: 'Крепко обнимемся — и всё пройдёт', partOfSpeech: 'expression', lessonId: 0 },
      ...
      { id: 'kg_p_15', hebrew: 'שִׂימוּ נַעֲלַיִּים, יוֹצְאִים לֶחָצֵר', hebrewPlain: 'שימו נעליים, יוצאים לחצר', transcription: 'сӣму наалáим, йоц’ӣм лехацéр', translation: 'Надевайте обувь, выходим во двор!', partOfSpeech: 'expression', lessonId: 0 },
      ...
      { id: 'kg_p_17', hebrew: 'מָה אָמַרְנוּ עַל זְרִיקַת חוֹל?', hebrewPlain: 'מה אמרנו על זריקת חול?', transcription: 'ма амáрנו аль зрикáт холь?', translation: 'Что мы договаривались насчёт бросания песком?', partOfSpeech: 'expression', lessonId: 0 },
      { id: 'kg_p_18', hebrew: 'הוּא אָכַל יָפֶה מְאוֹד הַיּוֹם', hebrewPlain: 'הוא אכל יפה מאוד היום', transcription: 'hу ахáль яфé меóд hайóм', translation: 'Он сегодня очень хорошо кушал', partOfSpeech: 'expression', lessonId: 0 },
      ...
      { id: 'kg_p_20', hebrew: 'הָיְיתָה לוֹ מַכָּה קְטַנָּה, שַׂמְנוּ קֶרַח', hebrewPlain: 'הייתה לו מכה קטנה, שמנו קרח', transcription: 'hайтá ло макá ктанá, сáмну кéрах', translation: 'Он слегка ударился, мы приложили лёд', partOfSpeech: 'expression', lessonId: 0 },
      { id: 'kg_p_21', hebrew: 'צָרִיךְ לְהָבִיא חִיתּוּלִים לַגַּן', hebrewPlain: 'צריך להביא חיתולים לגן', transcription: 'царӣх леhавӣ хитӯлӣм лагáн', translation: 'Нужно принести подгузники в сад', partOfSpeech: 'expression', lessonId: 0 },
      { id: 'kg_p_22', hebrew: 'נָא לְהָבִיא בְּגָדִים חַמִּים לְהַחְלָפָה', hebrewPlain: 'נא להביא בגדים חמים להחלפה', transcription: 'на леhавӣ бгадӣм хамӣм леhахлафá', translation: 'Пожалуйста, принесите тёплые вещи на смену', partOfSpeech: 'expression', lessonId: 0 },
      { id: 'kg_p_23', hebrew: 'הוּא הָיָה אַבָּא שֶׁל שַׁבָּת הַשָּׁבוּעַ', hebrewPlain: 'הוא היה אבא של שבת השבוע', transcription: 'hу hайá áба шель шабáт hашавӯа', translation: 'Он был «папой Шаббата» на этой неделе', partOfSpeech: 'expression', lessonId: 0 },
