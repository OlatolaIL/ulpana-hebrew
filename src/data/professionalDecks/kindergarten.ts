...
export const KINDERGARTEN_DECKS: ThematicDeck[] = [
  ...
  // ==========================================
  {
    ...
    titleHebrew: 'גַּן יְלָדִים — פְּעָלִים שֶׁל חִנּוּךְ וְטִפּוּל',
    ...
    words: [
      ...
      { id: 'kg_v_6', hebrew: 'לְצַיֵּר', hebrewPlain: 'לצייר', transcription: 'лецайéр', translation: 'рисовать', partOfSpeech: 'verb', root: 'צ-י-ר', lessonId: 0 },
      { id: 'kg_v_7', hebrew: 'לִגְזֹר', hebrewPlain: 'לגזור', transcription: 'лигзóр', translation: 'вырезать (ножницами)', partOfSpeech: 'verb', root: 'ג-ז-ר', lessonId: 0 },
      ...
      { id: 'kg_v_12', hebrew: 'לְהֵרָדֵם', hebrewPlain: 'להירדם', transcription: 'леhерадéм', translation: 'засыпать', partOfSpeech: 'verb', root: 'ר-ד-ם', lessonId: 0 },
      ...
      { id: 'kg_v_14', hebrew: 'לִנְעֹל', hebrewPlain: 'לנעול', transcription: 'линъóль', translation: 'обувать (ботинки, сандалии)', partOfSpeech: 'verb', root: 'נ-ע-ל', lessonId: 0 },
      { id: 'kg_v_15', hebrew: 'לְהַחְלִיף חִתּוּל', hebrewPlain: 'להחליף חיתול', transcription: 'леhахлӣф хитӯль', translation: 'менять подгузник', partOfSpeech: 'verb', root: 'ח-ל-ף', lessonId: 0 },
      { id: 'kg_v_16', hebrew: 'לִרְחֹץ יָדַיִם', hebrewPlain: 'לרחוץ ידיים', transcription: 'лирхóц ядáим', translation: 'мыть руки', partOfSpeech: 'verb', root: 'ר-ח-ץ', lessonId: 0 },
      ...
      { id: 'kg_v_18', hebrew: 'לְוַתֵּר', hebrewPlain: 'לוותר', transcription: 'леватéр', translation: 'уступать (очередь, игрушку)', partOfSpeech: 'verb', root: 'ו-ת-ר', lessonId: 0 },
      ...
      { id: 'kg_v_22', hebrew: 'לִשְׁמֹר עַל כְּלָלִים', hebrewPlain: 'לשמור על כללים', transcription: 'лишмóр аль клалӣм', translation: 'соблюдать правила', partOfSpeech: 'verb', root: 'ש-מ-ר', lessonId: 0 },
      ...
      { id: 'kg_v_24', hebrew: 'לִרְקֹד', hebrewPlain: 'לרקוד', transcription: 'лиркóд', translation: 'танцевать', partOfSpeech: 'verb', root: 'ר-ק-ד', lessonId: 0 },
      { id: 'kg_v_25', hebrew: 'לִגְמֹל', hebrewPlain: 'לגמול', transcription: 'лигмóль', translation: 'приучать к горшку / отучать от соски', partOfSpeech: 'verb', root: 'ג-מ-ל', lessonId: 0 },
    ],
  },
  ...
  // ==========================================
  {
    ...
    words: [
      ...
      { id: 'kg_d_7', hebrew: 'בֻּבָּה', hebrewPlain: 'בובה', transcription: 'бубá', translation: 'кукла', partOfSpeech: 'noun', gender: 'f', plural: 'בובות', lessonId: 0 },
      { id: 'kg_d_8', hebrew: 'קֻבִיּוֹת', hebrewPlain: 'קוביות', transcription: 'кубийóт', translation: 'строительные кубики, конструктор', partOfSpeech: 'noun', gender: 'f', lessonId: 0 },
      ...
      { id: 'kg_d_13', hebrew: 'מִסְפָּרַיִם', hebrewPlain: 'מספריים', transcription: 'миспарáим', translation: 'детские ножницы', partOfSpeech: 'noun', gender: 'f', root: 'ס-פ-ר', lessonId: 0 },
      ...
      { id: 'kg_d_15', hebrew: 'חִתּוּל', hebrewPlain: 'חיתול', transcription: 'хитӯль', translation: 'подгузник, памперс', partOfSpeech: 'noun', gender: 'm', root: 'ח-ת-ל', lessonId: 0 },
      ...
      { id: 'kg_d_25', hebrew: 'סַלְסִלָּה', hebrewPlain: 'סלסילה', transcription: 'сальсилá', translation: 'именная корзинка для вещей ребёнка', partOfSpeech: 'noun', gender: 'f', lessonId: 0 },
    ],
  },
  ...
  // ==========================================
  {
    ...
    icon: 'Users',
    words: [
      { id: 'kg_p_1', hebrew: 'בֹּקֶר טוֹב לְכֻלָּם!', hebrewPlain: 'בוקר טוב לכולם!', transcription: 'бóкер тов лехулáм!', translation: 'Доброе утро всем!', partOfSpeech: 'expression', lessonId: 0 },
      ...
      { id: 'kg_p_3', hebrew: 'תּוֹרְךָ עַכְשָׁו', hebrewPlain: 'תורך עכשיו', transcription: 'торхá ахшáв', translation: 'Сейчас твоя очередь (к мальчику)', partOfSpeech: 'expression', lessonId: 0 },
      { id: 'kg_p_4', hebrew: 'תּוֹרֵךְ עַכְשָׁו', hebrewPlain: 'תורך עכשיו', transcription: 'торéх ахшáв', translation: 'Сейчас твоя очередь (к девочке)', partOfSpeech: 'expression', lessonId: 0 },
      { id: 'kg_p_5', hebrew: 'לֹא לְהַרְבִּיץ, מְדַבְּרִים בְּמִלִּים', hebrewPlain: 'לא להרביץ', transcription: 'ло леhарбӣц, медабрӣм бемйлӣм', translation: 'Не драться! Мы говорим словами', partOfSpeech: 'expression', lessonId: 0 },
      ...
      { id: 'kg_p_9', hebrew: 'עַכְשָׁו אוֹסְפִים אֶת הַמִּשְׂחָקִים', hebrewPlain: 'עכשיו אוספים משחקים', transcription: 'ахшáв осфӣм эт hамисхакӣм', translation: 'А сейчас собираем игрушки!', partOfSpeech: 'expression', lessonId: 0 },
      { id: 'kg_p_10', hebrew: 'שָׁטַפְתָּ יָדַיִם עִם סַבּוֹן?', hebrewPlain: 'שטפת ידיים עם סבון?', transcription: 'шатáфта ядáим им сабóн?', translation: 'Ты помыл руки с мылом?', partOfSpeech: 'expression', lessonId: 0 },
      { id: 'kg_p_11', hebrew: 'כָּל הַכָּבוֹד, אֵיזֶה יֹפִי!', hebrewPlain: 'כל הכבוד', transcription: 'коль hакавóд, éйзе йóфи!', translation: 'Молодец, какая красота!', partOfSpeech: 'expression', lessonId: 0 },
      ...
      { id: 'kg_p_13', hebrew: 'חִבּוּק גָּדוֹל וְהַכֹּל עוֹבֵר', hebrewPlain: 'חיבוק גדול', transcription: 'хибӯк гадóль веhакóль овéр', translation: 'Крепко обнимемся — и всё пройдёт', partOfSpeech: 'expression', lessonId: 0 },
      { id: 'kg_p_14', hebrew: 'עַכְשָׁו זְמַן מְנוּחָה', hebrewPlain: 'עכשיו זמן מנוחה', transcription: 'ахшáв зман менухá', translation: 'Сейчас время тихого часа (отдыха)', partOfSpeech: 'expression', lessonId: 0 },
      { id: 'kg_p_15', hebrew: 'שִׂימוּ נַעֲלַיִם, יוֹצְאִים לֶחָצֵר', hebrewPlain: 'שימו נעליים', transcription: 'сӣму наалáим, йоц’ӣм лехацéр', translation: 'Надевайте обувь, выходим во двор!', partOfSpeech: 'expression', lessonId: 0 },
      ...
      { id: 'kg_p_18', hebrew: 'הוּא אָכַל יָפֶה מְאֹד הַיּוֹם', hebrewPlain: 'הוא אכל יפה מאוד', transcription: 'hу ахáль яфé меóд hайóм', translation: 'Он сегодня очень хорошо кушал', partOfSpeech: 'expression', lessonId: 0 },
      ...
      { id: 'kg_p_20', hebrew: 'הָיְתָה לוֹ מַכָּה קְטַנָּה, שַׂמְנוּ קֶרַח', hebrewPlain: 'הייתה לו מכה קטנה', transcription: 'hайтá ло макá ктанá, сáмну кéрах', translation: 'Он слегка ударился, мы приложили лёд', partOfSpeech: 'expression', lessonId: 0 },
      { id: 'kg_p_21', hebrew: 'צָרִיךְ לְהָבִיא חִתּוּלִים לַגַּן', hebrewPlain: 'צריך להביא חיתולים', transcription: 'царӣх леhавӣ хитӯлӣм лагáн', translation: 'Нужно принести подгузники в сад', partOfSpeech: 'expression', lessonId: 0 },
      ...
      { id: 'kg_p_25', hebrew: 'נִתְרָאֶה מָחָר בַּבֹּקֶר!', hebrewPlain: 'נתראה מחר בבוקר!', transcription: 'нитраé махáр бабóкер!', translation: 'Увидимся завтра утром!', partOfSpeech: 'expression', lessonId: 0 },
    ],
  },
];
