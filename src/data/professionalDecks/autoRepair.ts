...
export const AUTO_REPAIR_DECKS: ThematicDeck[] = [
  ...
  // ==========================================
  {
    ...
    icon: 'Wrench',
    words: [
      { id: 'ar_v_1', hebrew: 'לְתַקֵּן', hebrewPlain: 'לתקן', transcription: 'летакéн', translation: 'чинить, ремонтировать', partOfSpeech: 'verb', root: 'ת-ק-ן', lessonId: 63 },
      { id: 'ar_v_2', hebrew: 'לְפָרֵק', hebrewPlain: 'לפרק', transcription: 'лефарéк', translation: 'разбирать, демонтировать, снимать', partOfSpeech: 'verb', root: 'פ-ר-ק', lessonId: 63 },
      { id: 'ar_v_3', hebrew: 'לְהַרְכִּיב', hebrewPlain: 'להרכיב', transcription: 'леhаркӣв', translation: 'собирать, устанавливать, монтировать', partOfSpeech: 'verb', root: 'ר-כ-ב', lessonId: 63 },
      { id: 'ar_v_4', hebrew: 'לְהַחְלִיף', hebrewPlain: 'להחליף', transcription: 'леhахлӣф', translation: 'менять, заменять', partOfSpeech: 'verb', root: 'ח-ל-ף', lessonId: 63 },
      { id: 'ar_v_5', hebrew: 'לִבְדּוֹק', hebrewPlain: 'לבדוק', transcription: 'ливдóк', translation: 'проверять, диагностировать', partOfSpeech: 'verb', root: 'ב-ד-ק', lessonId: 63 },
      { id: 'ar_v_6', hebrew: 'לִבְלוֹם', hebrewPlain: 'לבלום', transcription: 'ливлóм', translation: 'тормозить', partOfSpeech: 'verb', root: 'ב-ל-ם', lessonId: 62 },
      { id: 'ar_v_7', hebrew: 'לְהָנִיעַ', hebrewPlain: 'להניע', transcription: 'леhанӣа', translation: 'заводить (двигатель), трогаться', partOfSpeech: 'verb', root: 'נ-ו-ע', lessonId: 62 },
      { id: 'ar_v_8', hebrew: 'לִגְרוֹר', hebrewPlain: 'לגרור', transcription: 'лигрóр', translation: 'буксировать, эвакуировать', partOfSpeech: 'verb', root: 'ג-р-ר', lessonId: 62 },
      { id: 'ar_v_9', hebrew: 'לְשַׁמֵּן', hebrewPlain: 'לשמן', transcription: 'лешамéн', translation: 'смазывать маслом', partOfSpeech: 'verb', root: 'ש-מ-ן', lessonId: 63 },
      { id: 'ar_v_10', hebrew: 'לְכַוֵּון', hebrewPlain: 'לכוון', transcription: 'лехавéн', translation: 'регулировать, настраивать', partOfSpeech: 'verb', root: 'כ-ו-ן', lessonId: 63 },
      { id: 'ar_v_11', hebrew: 'לְנַקֵּז', hebrewPlain: 'לנקז', transcription: 'ленакéз', translation: 'сливать, дренировать (жидкость)', partOfSpeech: 'verb', root: 'נ-ק-ז', lessonId: 63 },
      { id: 'ar_v_12', hebrew: 'לְמַלֵּא', hebrewPlain: 'למלא', transcription: 'лемалé', translation: 'заливать, наполнять, заправлять', partOfSpeech: 'verb', root: 'מ-ל-א', lessonId: 62 },
      { id: 'ar_v_13', hebrew: 'לְהַחְלִיק', hebrewPlain: 'להחליק', transcription: 'леhахлӣк', translation: 'скользить, буксовать', partOfSpeech: 'verb', root: 'ח-ל-ק', lessonId: 62 },
      { id: 'ar_v_14', hebrew: 'לְהַטְעִין', hebrewPlain: 'להטעין', transcription: 'леhатъӣн', translation: 'заряжать (аккумулятор)', partOfSpeech: 'verb', root: 'ט-ע-ן', lessonId: 63 },
      { id: 'ar_v_15', hebrew: 'לְנַקּוֹת', hebrewPlain: 'לנקות', transcription: 'ленакóт', translation: 'очищать, промывать', partOfSpeech: 'verb', root: 'נ-ק-ה', lessonId: 63 },
      { id: 'ar_v_16', hebrew: 'לְחַבֵּר', hebrewPlain: 'לחבר', transcription: 'лехабéр', translation: 'соединять, подключать', partOfSpeech: 'verb', root: 'ח-ב-ר', lessonId: 63 },
      { id: 'ar_v_17', hebrew: 'לְנַתֵּק', hebrewPlain: 'לנתק', transcription: 'ленатéк', translation: 'отключать, отсоединять клеммы', partOfSpeech: 'verb', root: 'נ-ת-ק', lessonId: 63 },
      { id: 'ar_v_18', hebrew: 'לְהַדֵּק', hebrewPlain: 'להדק', transcription: 'леhадéк', translation: 'затягивать (гайки, болты)', partOfSpeech: 'verb', root: 'ה-ד-ק', lessonId: 63 },
      { id: 'ar_v_19', hebrew: 'לִפְתּוֹחַ בּוֹרֶג', hebrewPlain: 'לפתוח בורג', transcription: 'лифтóах бóрег', translation: 'откручивать болт', partOfSpeech: 'verb', root: 'פ-ת-ח', lessonId: 63 },
      { id: 'ar_v_20', hebrew: 'לְהַחְלִיף שֶׁמֶן', hebrewPlain: 'להחליף שמן', transcription: 'леhахлӣф шéмен', translation: 'менять масло', partOfSpeech: 'verb', root: 'ח-ל-ף', lessonId: 63 },
      { id: 'ar_v_21', hebrew: 'לְהִתְחַמֵּם', hebrewPlain: 'להתחמם', transcription: 'леhитхамéм', translation: 'перегреваться (о моторе)', partOfSpeech: 'verb', root: 'ח-מ-מ', lessonId: 62 },
      { id: 'ar_v_22', hebrew: 'לִדְלוֹף', hebrewPlain: 'לדלוף', transcription: 'лидлóф', translation: 'протекать, подтекать', partOfSpeech: 'verb', root: 'ד-ל-ף', lessonId: 63 },
      { id: 'ar_v_23', hebrew: 'לִפְנוֹת', hebrewPlain: 'לפנות', transcription: 'лифнóт', translation: 'поворачивать', partOfSpeech: 'verb', root: 'פ-נ-ה', lessonId: 62 },
      { id: 'ar_v_24', hebrew: 'לַעֲשׂוֹת טֶסְט', hebrewPlain: 'לעשות טסט', transcription: 'лаасóт тест', translation: 'проходить техосмотр', partOfSpeech: 'verb', root: 'ע-ש-ה', lessonId: 62 },
      { id: 'ar_v_25', hebrew: 'לֶאֱטוֹם', hebrewPlain: 'לאטום', transcription: 'леэтóм', translation: 'герметизировать, уплотнять', partOfSpeech: 'verb', root: 'א-ט-ם', lessonId: 63 },
    ],
  },
