...
export const AUTO_REPAIR_DECKS: ThematicDeck[] = [
  ...
  // ==========================================
  {
    ...
    words: [
      ...
      { id: 'ar_d_11', hebrew: 'הַצָּעַת מְחִיר לְתִיקּוּן', hebrewPlain: 'הצעת מחיר', transcription: 'hацаáт мехӣр', translation: 'Ценовое предложение (смета) на ремонт', partOfSpeech: 'noun', gender: 'f', lessonId: 0 },
