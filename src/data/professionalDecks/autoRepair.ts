...
export const AUTO_REPAIR_DECKS: ThematicDeck[] = [
  ...
  // ==========================================
  {
    ...
    titleHebrew: 'מוּסָךְ — פְּעָלִים שֶׁל תִּקּוּן וְטִפּוּל',
    ...
    words: [
      ...
      { id: 'ar_v_5', hebrew: 'לִבְדֹּק', hebrewPlain: 'לבדוק', transcription: 'ливдóк', translation: 'проверять, диагностировать', partOfSpeech: 'verb', root: 'ב-ד-ק', lessonId: 0 },
      { id: 'ar_v_6', hebrew: 'לִבְלֹם', hebrewPlain: 'לבלום', transcription: 'ливлóм', translation: 'тормозить', partOfSpeech: 'verb', root: 'ב-ל-ם', lessonId: 0 },
      ...
      { id: 'ar_v_8', hebrew: 'לִגְרֹר', hebrewPlain: 'לגרור', transcription: 'лигрóр', translation: 'буксировать, эвакуировать', partOfSpeech: 'verb', root: 'ג-р-ר', lessonId: 0 },
      ...
      { id: 'ar_v_10', hebrew: 'לְכַוֵּן', hebrewPlain: 'לכוון', transcription: 'лехавéн', translation: 'регулировать, настраивать', partOfSpeech: 'verb', root: 'כ-ו-ן', lessonId: 0 },
      ...
      { id: 'ar_v_19', hebrew: 'לִפְתֹּחַ בֹּרֶג', hebrewPlain: 'לפתוח בורג', transcription: 'лифтóах бóрег', translation: 'откручивать болт', partOfSpeech: 'verb', root: 'פ-ת-ח', lessonId: 0 },
      ...
      { id: 'ar_v_22', hebrew: 'לִדְלֹף', hebrewPlain: 'לדלוף', transcription: 'лидлóф', translation: 'протекать, подтекать', partOfSpeech: 'verb', root: 'ד-ל-ף', lessonId: 0 },
      { id: 'ar_v_23', hebrew: 'לִפְנֹת', hebrewPlain: 'לפנות', transcription: 'лифнóт', translation: 'поворачивать', partOfSpeech: 'verb', root: 'פ-נ-ה', lessonId: 0 },
      ...
      { id: 'ar_v_25', hebrew: 'לֶאֱטֹם', hebrewPlain: 'לאטום', transcription: 'леэтóм', translation: 'герметизировать, уплотнять', partOfSpeech: 'verb', root: 'א-ט-ם', lessonId: 0 },
    ],
  },
  ...
  // ==========================================
  {
    ...
    words: [
      ...
      { id: 'ar_p_7', hebrew: 'תֵּבַת הִלּוּכִים', hebrewPlain: 'תיבת הילוכים', transcription: 'тейвáт hилухӣм', translation: 'коробка передач', partOfSpeech: 'noun', gender: 'f', lessonId: 0 },
      ...
      { id: 'ar_p_13', hebrew: 'רְצוּעַת טַיְמִינְג', hebrewPlain: 'רצועת טיימינג', transcription: 'рецуáт тáйминг', translation: 'ремень ГРМ', partOfSpeech: 'noun', gender: 'f', lessonId: 0 },
      ...
      { id: 'ar_p_19', hebrew: 'נוֹזֵל קֵרוּר', hebrewPlain: 'נוזל קירור', transcription: 'нозéль кирӯр', translation: 'охлаждающая жидкость, антифриз', partOfSpeech: 'noun', gender: 'm', lessonId: 0 },
      ...
      { id: 'ar_p_25', hebrew: 'חֶלְקֵי חִלּוּף', hebrewPlain: 'חלקי חילוף', transcription: 'хелькéй хилу́ф', translation: 'запасные части, запчасти', partOfSpeech: 'noun', gender: 'm', root: 'ח-ל-ף', lessonId: 0 },
    ],
  },
  ...
  // ==========================================
  {
    ...
    words: [
      ...
      { id: 'ar_t_4', hebrew: 'בֹּרֶג', hebrewPlain: 'בורג', transcription: 'бóрег', translation: 'болт, винт', partOfSpeech: 'noun', gender: 'm', plural: 'ברגים', lessonId: 0 },
      ...
      { id: 'ar_t_9', hebrew: 'מַד לַחַץ אֲוִיר', hebrewPlain: 'מד לחץ אוויר', transcription: 'мад лáхац авӣр', translation: 'манометр (давление в шинах)', partOfSpeech: 'noun', gender: 'm', root: 'מ-ד-ד', lessonId: 0 },
      ...
      { id: 'ar_t_19', hebrew: 'מֶלְקָחַיִם / מַלְחֵץ', hebrewPlain: 'מלחציים', transcription: 'мелхацáим', translation: 'тиски', partOfSpeech: 'noun', gender: 'f', lessonId: 0 },
      ...
      { id: 'ar_t_21', hebrew: 'מַד עֹמֶק חֲרִיצִים', hebrewPlain: 'מד עומק', transcription: 'мад óмек', translation: 'глубиномер протектора шин', partOfSpeech: 'noun', gender: 'm', root: 'מ-ד-ד', lessonId: 0 },
      { id: 'ar_t_22', hebrew: 'חֹמֶר שִׁמּוּן', hebrewPlain: 'חומר שימון', transcription: 'хóмер шиму́н', translation: 'смазочный спрей (WD-40)', partOfSpeech: 'noun', gender: 'm', root: 'ש-מ-ן', lessonId: 0 },
  ...
  // ==========================================
  {
    ...
    words: [
      ...
      { id: 'ar_d_5', hebrew: 'נִדְלְקָה נְוּרַת מָנוֹעַ', hebrewPlain: 'נדלקה נורת מנוע', transcription: 'нидлекá нӯрат манóа', translation: 'Загорелась лампочка Check Engine', partOfSpeech: 'expression', lessonId: 0 },
      ...
      { id: 'ar_d_11', hebrew: 'הַצָּעַת מְחִיר לְתִקּוּן', hebrewPlain: 'הצעת מחיר', transcription: 'hацаáт мехӣр', translation: 'Ценовое предложение (смета) на ремонт', partOfSpeech: 'noun', gender: 'f', lessonId: 0 },
      ...
      { id: 'ar_d_13', hebrew: 'כַּמָּה זְמַן יִקַּח הַתִּקּוּן?', hebrewPlain: 'כמה זמן יקח התיקון?', transcription: 'кáма зман йикáх hатикӯн?', translation: 'Сколько времени займёт ремонт?', partOfSpeech: 'expression', lessonId: 0 },
      ...
      { id: 'ar_d_15', hebrew: 'נִתְקַשֵּׁר אֵלֶיךָ כְּשֶׁזֶּה יִהְיֶה מוּכָן', hebrewPlain: 'נתקשר אליך', transcription: 'ниткашéр элéйха кшезэ йиhйé мухáн', translation: 'Мы позвоним вам, когда всё будет готово', partOfSpeech: 'expression', lessonId: 0 },
      { id: 'ar_d_16', hebrew: 'טִפּוּל עֲשָׂרָה אֲלָפִים', hebrewPlain: 'טיפול עשרת אלפים', transcription: 'типӯль асарá алафӣм', translation: 'ТО на 10,000 км (базовое техобслуживание)', partOfSpeech: 'noun', gender: 'm', root: 'ט-פ-ל', lessonId: 0 },
      ...
      { id: 'ar_d_19', hebrew: 'יֵשׁ אַחֲרָיוּת עַל הַתִּקּוּן?', hebrewPlain: 'יש אחריות על התיקון?', transcription: 'йеш ахрайӯт аль hатикӯн?', translation: 'Есть гарантия на ремонт?', partOfSpeech: 'expression', lessonId: 0 },
      { id: 'ar_d_20', hebrew: 'חֲבֶרַת בִּטּוּחַ', hebrewPlain: 'חברת ביטוח', transcription: 'хеврáт битӯах', translation: 'Страховая компания', partOfSpeech: 'noun', gender: 'f', root: 'ב-ט-ח', lessonId: 0 },
      ...
      { id: 'ar_d_23', hebrew: 'טֶוֹטַל-לוֹס', hebrewPlain: 'טוטל לוס', transcription: 'тóтал лосс', translation: 'Машина не подлежит восстановлению (total loss)', partOfSpeech: 'expression', lessonId: 0 },
