...
export const CAR_WASH_DECKS: ThematicDeck[] = [
  ...
  // ==========================================
  {
    ...
    icon: 'Sparkles',
    words: [
      { id: 'cw_d_1', hebrew: 'שָׁלוֹם, רַק שְׁטִיפָה חִיצוֹנִית אוֹ גַּם פְּנִים?', hebrewPlain: 'שטיפה חיצונית או פנים?', transcription: 'шалóм, рак штифá хицонӣт о гам пним?', translation: 'Здравствуйте! Только снаружи или салон тоже?', partOfSpeech: 'expression', lessonId: 0 },
      { id: 'cw_d_2', hebrew: 'לְהַכְנִיס אֶת הָרֶכֶב לְנֵיטְרָל וְלֹא לִלְחוֹץ עַל הַבֶּלֶם', hebrewPlain: 'להכניס לניטרל ולא ללחוץ על הבלם', transcription: 'леhахнӣс эт hарéхев ленейтрáль велó лильхóц аль hабéлем', translation: 'Поставьте машину на нейтралку и не жмите тормоз', partOfSpeech: 'expression', lessonId: 0 },
      { id: 'cw_d_3', hebrew: 'נָא לְהוֹרִיד אֶת בֶּלֶם הַיָּד וּלְקַפֵּל מַרְאוֹת', hebrewPlain: 'להוריד בלם יד ולקפל מראות', transcription: 'на леhорӣд эт бéлем hайáд улекапéль мар’óт', translation: 'Пожалуйста, опустите ручник и сложите боковые зеркала', partOfSpeech: 'expression', lessonId: 0 },
      { id: 'cw_d_4', hebrew: 'תִּסְגּוֹר אֶת כָּל הַחַלּוֹנוֹת עַד הַסּוֹף', hebrewPlain: 'לסגור חלונות עד הסוף', transcription: 'тисгóр эт коль hахалонóт ад hасóф', translation: 'Закройте все окна плотно до упора', partOfSpeech: 'expression', lessonId: 0 },
      { id: 'cw_d_5', hebrew: 'לְרוֹקֵן אֶת הַבָּגָאז׳ אוֹ שֶׁאֵין צֹרֶךְ לִשְׁאוֹב שָׁם?', hebrewPlain: 'לרוקן את הבגאז או לשאוב?', transcription: 'лерокéн эт hабагáж о шеэйн цóрех лиш’óв шам?', translation: 'Освободить багажник или там пылесосить не нужно?', partOfSpeech: 'expression', lessonId: 0 },
      { id: 'cw_d_6', hebrew: 'לִשְׁטוֹף אֶת שְׁטִיחֵי הַגּוּמִי בְּמַיִם?', hebrewPlain: 'לשטוף שטיחי גומי במים?', transcription: 'лиштóф эт штихéй hагӯми бемáйим?', translation: 'Помыть резиновые коврики струёй воды?', partOfSpeech: 'expression', lessonId: 0 },
      { id: 'cw_d_7', hebrew: 'יֵשׁ לָכֶם דְּבָרִים יְקָרֵי עֵרֶךְ בְּתוֹךְ הָרֶכֶב?', hebrewPlain: 'יש דברים יקרי ערך ברכב?', transcription: 'йеш лахéм дварӣм йкрéй э́рех бетóх hарéхев?', translation: 'В салоне остались какие-то ценные вещи?', partOfSpeech: 'expression', lessonId: 0 },
      { id: 'cw_d_8', hebrew: 'לָשִׂים לְךָ עֵץ רֵיחַ? אֵיזֶה רֵיחַ אַתָּה מַעֲדִיף?', hebrewPlain: 'לשים עץ ריח איזה ריח?', transcription: 'ласӣм лехá эц рéйах? э́йзеh рéйах атá маадӣф?', translation: 'Повесить пахучку? Какой аромат предпочитаете?', partOfSpeech: 'expression', lessonId: 0 },
      { id: 'cw_d_9', hebrew: 'רוֹצֶה גַּם הַבְרָקַת צְמִיגִים וְוַקְס חַם?', hebrewPlain: 'רוצה הברקת צמיגים ווקס חם?', transcription: 'роцé гам hавракáт цмигӣм вевáкс хам?', translation: 'Хотите также чернение шин и горячий воск?', partOfSpeech: 'expression', lessonId: 0 },
      { id: 'cw_d_10', hebrew: 'יֵשׁ כֶּתֶם קָשֶׁה עַל הָרִפּוּד שֶׁדּוֹרֵשׁ חוֹמֶר מְיוּחָד', hebrewPlain: 'יש כתם קשה על הריפוד', transcription: 'йеш кéтем кашé аль hарипӯд шедорéш хóмер мейухáд', translation: 'На обивке сиденья стойкое пятно, нужна спецхимия', partOfSpeech: 'expression', lessonId: 0 },
      { id: 'cw_d_11', hebrew: 'נָא לְהַמְתִּין בַּחֲדַר הַהַמְתָּנָה הַמְּמוּזָג', hebrewPlain: 'להמתין בחדר ההמתנה', transcription: 'на леhамтӣн бахадáр hаhамтанá hамемузáг', translation: 'Пожалуйста, подождите в зале ожидания с кондиционером', partOfSpeech: 'expression', lessonId: 0 },
      { id: 'cw_d_12', hebrew: 'תִּפְתַּח לִי אֶת תָּא הַמִּטְעָן בְּבַקָּשָׁה', hebrewPlain: 'תפתח את תא המטען בבקשה', transcription: 'тифтáх ли эт та hамит’áн бевакашá', translation: 'Откройте мне, пожалуйста, багажник', partOfSpeech: 'expression', lessonId: 0 },
      { id: 'cw_d_13', hebrew: 'נִשְׁאַר כֶּתֶם עַל הַשִּׁמְשָׁה, אֲנִי מְנַגֵּב שׁוּב', hebrewPlain: 'נשאר כתם על השמשה מנגב שוב', transcription: 'ниш’áр кéтем аль hашимшá, анӣ менагéв шув', translation: 'Остался след на стекле, я протру его ещё раз', partOfSpeech: 'expression', lessonId: 0 },
      { id: 'cw_d_14', hebrew: 'הַמְּכוֹנִית שֶׁלְּךָ מוּכָנָה וּנְקִיָּה לַחֲלוּטִין!', hebrewPlain: 'המכונית שלך מוכנה ונקיה', transcription: 'hамехонӣт шельхá муханá унекийá лахалутӣн!', translation: 'Ваша машина готова и сияет чистотой!', partOfSpeech: 'expression', lessonId: 0 },
      { id: 'cw_d_15', hebrew: 'הַשְּׁטִיפָה לוֹקַחַת בְּעֵרֶךְ עֶשְׂרִים דַּקּוֹת', hebrewPlain: 'השטיפה לוקחת עשרים דקות', transcription: 'hаштифá локáхат беэ́рех эсрӣм дакóт', translation: 'Мойка займёт около двадцати минут', partOfSpeech: 'expression', lessonId: 0 },
      { id: 'cw_d_16', hebrew: 'לְהַבְרִיק אֶת הַדֶּשְׁבּוֹרְד עִם תַּרְסִיס מַבְרִיק אוֹ מָאט?', hebrewPlain: 'להבריק את הדשבורד מבריק או מאט?', transcription: 'леhаврӣк эт hадéшборд им тарсӣс маврӣк о мат?', translation: 'Натереть торпедо глянцевым или матовым средством?', partOfSpeech: 'expression', lessonId: 0 },
      { id: 'cw_d_17', hebrew: 'תִּזָּהֵר כְּשֶׁאַתָּה יוֹצֵא, הָרִצְפָּה כָּאן רְטוּבָה וּמַחֲלִיקָה', hebrewPlain: 'זהירות רצפה רטובה ומחליקה', transcription: 'тизаhéр кшеатá йоцé, hарицпá кан ретувá умахликá', translation: 'Осторожно при выходе, пол здесь мокрый и скользкий', partOfSpeech: 'expression', lessonId: 0 },
      { id: 'cw_d_18', hebrew: 'אֶפְשָׁר לְקַבֵּל כַּרְטִיס מָנוּי — כָּל שְׁטִיפָה עֲשִׂירִית חִנָּם', hebrewPlain: 'כרטיס מנוי שטיפה עשירית חינם', transcription: 'эфшáр лекабéль картӣс манӯй — коль штифá асирӣт хинáм', translation: 'Можно оформить абонемент: каждая десятая мойка бесплатно', partOfSpeech: 'expression', lessonId: 0 },
      { id: 'cw_d_19', hebrew: 'הַאִם לִשְׁאוֹב אֶת כִּסְאוֹת הַבְּטִיחוּת שֶׁל הַיְּלָדִים?', hebrewPlain: 'לשאוב כסאות בטיחות ילדים?', transcription: 'hаӣм лиш’óв эт кис’óт hавтихӯт шель hайладӣм?', translation: 'Пропылесосить детские автомобильные кресла?', partOfSpeech: 'expression', lessonId: 0 },
      { id: 'cw_d_20', hebrew: 'שְׁפֹךְ קְצָת מַסִּיר שֻׁמָּנִים עַל הַגַּ׳נְטִים', hebrewPlain: 'לשים מסיר שומנים על הגנטים', transcription: 'шфох кцат масӣр шуманӣм аль hажáнтим', translation: 'Побрызгай немного обезжиривателя на диски', partOfSpeech: 'expression', lessonId: 0 },
      { id: 'cw_d_21', hebrew: 'סַע קָדִימָה לְאַט עַד הַסִּימוּן הַיָּרֹק', hebrewPlain: 'סע קדימה עד הסימון הירוק', transcription: 'са кадӣма леáт ад hасимӯн hайарóк', translation: 'Двигайтесь вперёд медленно до зелёного индикатора', partOfSpeech: 'expression', lessonId: 0 },
      { id: 'cw_d_22', hebrew: 'נִקִּינוּ גַּם אֶת סִפֵּי הַדְּלָתוֹת וּפְנִים מִכְסֵה הַדֶּלֶק', hebrewPlain: 'ניקינו ספי דלתות ומכסה הדלק', transcription: 'никӣну гам эт сипéй hадлатóт уфнӣм михсé hадéлек', translation: 'Мы протёрли также дверные пороги и лючок бензобака', partOfSpeech: 'expression', lessonId: 0 },
      { id: 'cw_d_23', hebrew: 'תִּבְדּוֹק שֶׁשּׁוּם דָּבָר לֹא נִשְׁכַּח בַּתָּאִים הַצְּדָדִיִּים', hebrewPlain: 'תבדוק שלא נשכח שום דבר', transcription: 'тивдóк шешӯм давáр ло нишкáх батаӣм hацдадийӣм', translation: 'Проверьте, не забыто ли что-то в боковых карманах дверей', partOfSpeech: 'expression', lessonId: 0 },
      { id: 'cw_d_24', hebrew: 'הַתַּשְׁלוּם מִתְבַּצֵּעַ בַּקֻּפָּה בַּיְּצִיאָה', hebrewPlain: 'תשלום בקופה ביציאה', transcription: 'hаташлу́м митбацéа бакупá байециá', translation: 'Оплата производится в кассе на выезде', partOfSpeech: 'expression', lessonId: 0 },
      { id: 'cw_d_25', hebrew: 'נְסִיעָה טוֹבָה וּבְטוּחָה בָּרֶכֶב הַמַּבְרִיק שֶׁלְּךָ!', hebrewPlain: 'נסיעה טובה ברכב המבריק שלך', transcription: 'несиá товá увтухá барéхев hамаврӣк шельхá!', translation: 'Счастливого и безопасного пути на вашем чистом автомобиле!', partOfSpeech: 'expression', lessonId: 0 },
    ],
  },
];
