...
export const CAR_WASH_DECKS: ThematicDeck[] = [
  ...
  // ==========================================
  {
    ...
    icon: 'Droplets',
    words: [
      { id: 'cw_v_1', hebrew: 'לִשְׁטוֹף', hebrewPlain: 'לשטוף', transcription: 'лиштóф', translation: 'мыть, смывать струёй воды', partOfSpeech: 'verb', root: 'ש-ט-ף', lessonId: 7 },
      { id: 'cw_v_2', hebrew: 'לִרְחוֹץ', hebrewPlain: 'לרחוץ', transcription: 'лирхóц', translation: 'мыть (автомобиль)', partOfSpeech: 'verb', root: 'ר-ח-ץ', lessonId: 7 },
      { id: 'cw_v_3', hebrew: 'לְהַקְצִיף', hebrewPlain: 'להקציף', transcription: 'леhакцӣф', translation: 'наносить пену, покрывать активной пеной', partOfSpeech: 'verb', root: 'ק-צ-ף', lessonId: 7 },
      { id: 'cw_v_4', hebrew: 'לְנַגֵּב', hebrewPlain: 'לנגב', transcription: 'ленагéв', translation: 'вытирать насухо, протирать микрофиброй', partOfSpeech: 'verb', root: 'נ-ג-ב', lessonId: 7 },
      { id: 'cw_v_5', hebrew: 'לִשְׁאוֹב אָבָק', hebrewPlain: 'לשאוב אבק', transcription: 'лиш’óв авáк', translation: 'пылесосить салон и багажник', partOfSpeech: 'verb', root: 'ש-א-ב', lessonId: 7 },
      { id: 'cw_v_6', hebrew: 'לְהַבְרִיק', hebrewPlain: 'להבריק', transcription: 'леhаврӣк', translation: 'наводить глянец, заставлять блестеть', partOfSpeech: 'verb', root: 'ב-ר-ק', lessonId: 62 },
      { id: 'cw_v_7', hebrew: 'לַעֲשׂוֹת פּוֹלִישׁ', hebrewPlain: 'לעשות פוליש', transcription: 'лаасóт пóлиш', translation: 'полировать кузов полировочной пастой', partOfSpeech: 'verb', lessonId: 62 },
      { id: 'cw_v_8', hebrew: 'לִמְרוֹחַ וַקְס', hebrewPlain: 'למרוח וקס', transcription: 'лимрóах вакс', translation: 'наносить воск, натирать воском', partOfSpeech: 'verb', root: 'מ-ר-ח', lessonId: 62 },
      { id: 'cw_v_9', hebrew: 'לְיַבֵּשׁ', hebrewPlain: 'לייבש', transcription: 'лейабéш', translation: 'сушить (воздухом или салфетками)', partOfSpeech: 'verb', root: 'י-ב-ש', lessonId: 7 },
      { id: 'cw_v_10', hebrew: 'לְרַסֵּס', hebrewPlain: 'לרסס', transcription: 'лерасéс', translation: 'распылять спрей, брызгать химию', partOfSpeech: 'verb', root: 'ר-ס-ס', lessonId: 7 },
      { id: 'cw_v_11', hebrew: 'לְקַרְצֵף', hebrewPlain: 'לקרצף', transcription: 'лекарцéф', translation: 'оттирать щёткой, драить въевшуюся грязь', partOfSpeech: 'verb', root: 'ק-ר-צ-ף', lessonId: 7 },
      { id: 'cw_v_12', hebrew: 'לְהַתִּיז', hebrewPlain: 'להתיז', transcription: 'леhатӣз', translation: 'подавать струю под напором, обрызгивать', partOfSpeech: 'verb', root: 'נ-ת-ז', lessonId: 7 },
      { id: 'cw_v_13', hebrew: 'לְהָסִיר כְּתָמִים', hebrewPlain: 'להסיר כתמים', transcription: 'леhасӣр ктамӣм', translation: 'выводить пятна (с обивки / смолу с кузова)', partOfSpeech: 'verb', root: 'ס-ו-ר', lessonId: 7 },
      { id: 'cw_v_14', hebrew: 'לְהַשְׁחִיר צְמִיגִים', hebrewPlain: 'להשחיר צמיגים', transcription: 'леhашхӣр цмигӣм', translation: 'чернить покрышки, натирать резину блеском', partOfSpeech: 'verb', root: 'ש-ח-ר', lessonId: 62 },
      { id: 'cw_v_15', hebrew: 'לְחַטֵּא', hebrewPlain: 'לחטא', transcription: 'лехатé', translation: 'дезинфицировать салон, озонировать', partOfSpeech: 'verb', root: 'ח-ט-א', lessonId: 23 },
      { id: 'cw_v_16', hebrew: 'לְבַשֵּׂם', hebrewPlain: 'לבשם', transcription: 'левасéм', translation: 'ароматизировать салон, брызгать отдушку', partOfSpeech: 'verb', root: 'ב-ש-ם', lessonId: 7 },
      { id: 'cw_v_17', hebrew: 'לְרוֹקֵן מַאֲפֵרָה', hebrewPlain: 'לרוקן מאפרה', transcription: 'лерокéн мааферá', translation: 'вытряхивать пепельницу', partOfSpeech: 'verb', root: 'ר-י-ק', lessonId: 62 },
      { id: 'cw_v_18', hebrew: 'לְנַעֵר שְׁטִיחִים', hebrewPlain: 'לנער שטיחים', transcription: 'ленаéр штихӣм', translation: 'выбивать и встряхивать коврики', partOfSpeech: 'verb', root: 'נ-ע-ר', lessonId: 7 },
      { id: 'cw_v_19', hebrew: 'לִשְׁטוֹף בְּלַחַץ', hebrewPlain: 'לשטוף בלחץ', transcription: 'лиштóф белáхац', translation: 'обмывать под высоким давлением (гарником)', partOfSpeech: 'verb', root: 'ש-ט-ף', lessonId: 7 },
      { id: 'cw_v_20', hebrew: 'לְהַכְנִיס לַמִּנְהָרָה', hebrewPlain: 'להכניס למנהרה', transcription: 'леhахнӣс ламинhарá', translation: 'заводить автомобиль в автоматический туннель', partOfSpeech: 'verb', root: 'כ-נ-ס', lessonId: 62 },
      { id: 'cw_v_21', hebrew: 'לְהַעֲבִיר לְנֵיטְרָל', hebrewPlain: 'להעביר לניטרל', transcription: 'леhаавӣр ленейтрáль', translation: 'переключать коробку передач на нейтраль', partOfSpeech: 'verb', root: 'ע-ב-ר', lessonId: 62 },
      { id: 'cw_v_22', hebrew: 'לְשַׁחְרֵר בֶּלֶם יָד', hebrewPlain: 'לשחרר בלם יד', transcription: 'лешахрéр бéлем йад', translation: 'отпускать ручной тормоз', partOfSpeech: 'verb', root: 'ש-ח-ר-ר', lessonId: 62 },
      { id: 'cw_v_23', hebrew: 'לִסְגּוֹר חַלּוֹנוֹת', hebrewPlain: 'לסגור חלונות', transcription: 'лисгóр халонóт', translation: 'плотно закрывать все стёкла', partOfSpeech: 'verb', root: 'ס-ג-ר', lessonId: 62 },
      { id: 'cw_v_24', hebrew: 'לְקַפֵּל מַרְאוֹת', hebrewPlain: 'לקפל מראות', transcription: 'лекапéль мар’óт', translation: 'складывать боковые зеркала перед мойкой', partOfSpeech: 'verb', root: 'ק-פ-ל', lessonId: 62 },
      { id: 'cw_v_25', hebrew: 'לִמְסוֹר אֶת הָרֶכֶב', hebrewPlain: 'למסור את הרכב', transcription: 'лимсóр эт hарéхев', translation: 'сдавать вымытый чистый автомобиль водителю', partOfSpeech: 'verb', root: 'מ-ס-ר', lessonId: 62 },
    ],
  },
  ...
  // ==========================================
  {
    ...
    words: [
      ...
      { id: 'cw_t_13', hebrew: 'מַסִּיר שׁוּמָּנִים', hebrewPlain: 'מסיר שומנים', transcription: 'масӣр шуманӣм', translation: 'обезжириватель (дегризер для битума и масла)', partOfSpeech: 'noun', gender: 'm', root: 'ס-ו-ר', lessonId: 0 },
  ...
  // ==========================================
  {
    ...
    words: [
      ...
      { id: 'cw_d_20', hebrew: 'שְׁפוֹךְ קְצָת מַסִּיר שׁוּמָּנִים עַל הַגַּ׳נְטִים', hebrewPlain: 'שפוך קצת מסיר שומנים על הג׳נטים', transcription: 'шфох кцат масӣр шуманӣм аль hажáнтим', translation: 'Побрызгай немного обезжиривателя на диски', partOfSpeech: 'expression', lessonId: 0 },
      ...
      { id: 'cw_d_24', hebrew: 'הַתַּשְׁלוּם מִתְבַּצֵּעַ בַּקּוּפָּה בַּיְּצִיאָה', hebrewPlain: 'התשלום מתבצע בקופה ביציאה', transcription: 'hаташлу́м митбацéа бакупá байециá', translation: 'Оплата производится в кассе на выезде', partOfSpeech: 'expression', lessonId: 0 },
