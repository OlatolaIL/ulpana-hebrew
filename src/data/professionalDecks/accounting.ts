...
export const ACCOUNTING_DECKS: ThematicDeck[] = [
  ...
  // ==========================================
  {
    ...
    icon: 'Calculator',
    words: [
      { id: 'acc_v_1', hebrew: 'לְחַשֵּׁב', hebrewPlain: 'לחשב', transcription: 'лехашéв', translation: 'рассчитывать, вычислять', partOfSpeech: 'verb', root: 'ח-ש-ב', lessonId: 14 },
      { id: 'acc_v_2', hebrew: 'לְחַיֵּיב', hebrewPlain: 'לחייב', transcription: 'лехайéв', translation: 'дебетовать, списывать со счёта, начислять к оплате', partOfSpeech: 'verb', root: 'ח-י-ב', lessonId: 14 },
      { id: 'acc_v_3', hebrew: 'לְזַכּוֹת', hebrewPlain: 'לזכות', transcription: 'лезакóт', translation: 'кредитовать, возмещать средства, начислять льготу', partOfSpeech: 'verb', root: 'ז-כ-ה', lessonId: 14 },
      { id: 'acc_v_4', hebrew: 'לְהָפִיק', hebrewPlain: 'להפיק', transcription: 'леhафӣк', translation: 'выпускать, генерировать (счёт, отчёт)', partOfSpeech: 'verb', root: 'פ-ו-ק', lessonId: 48 },
      { id: 'acc_v_5', hebrew: 'לְקַזֵּז', hebrewPlain: 'לקזז', transcription: 'леказéз', translation: 'взаимозачитывать, сальдировать (налог)', partOfSpeech: 'verb', root: 'ק-ז-ז', lessonId: 48 },
      { id: 'acc_v_6', hebrew: 'לְנַכּוֹת', hebrewPlain: 'לנכות', transcription: 'ленакóт', translation: 'удерживать, вычитать (налог у источника)', partOfSpeech: 'verb', root: 'נ-כ-ה', lessonId: 48 },
      { id: 'acc_v_7', hebrew: 'לִגְבּוֹת', hebrewPlain: 'לגבות', transcription: 'лигбóт', translation: 'взимать, собирать оплату с клиентов', partOfSpeech: 'verb', root: 'ג-ב-ה', lessonId: 14 },
      { id: 'acc_v_8', hebrew: 'לְדַוֵּוחַ', hebrewPlain: 'לדווח', transcription: 'ледавéах', translation: 'подавать отчётность, декларировать', partOfSpeech: 'verb', root: 'ד-ו-ח', lessonId: 48 },
      { id: 'acc_v_9', hebrew: 'לְאַזֵּן', hebrewPlain: 'לאזן', transcription: 'леазéн', translation: 'сводить баланс, уравновешивать', partOfSpeech: 'verb', root: 'א-ז-ן', lessonId: 14 },
      { id: 'acc_v_10', hebrew: 'לְהַפְקִיד', hebrewPlain: 'להפקיד', transcription: 'леhафкӣд', translation: 'вносить на банковский счёт, депонировать', partOfSpeech: 'verb', root: 'פ-ק-ד', lessonId: 14 },
      { id: 'acc_v_11', hebrew: 'לִמְשׁוֹךְ כֶּסֶף', hebrewPlain: 'למשוך כסף', transcription: 'лимшóх кéсеф', translation: 'снимать деньги со счёта', partOfSpeech: 'verb', root: 'מ-ש-ך', lessonId: 14 },
      { id: 'acc_v_12', hebrew: 'לְהַעֲבִיר תַּשְׁלוּם', hebrewPlain: 'להעביר תשלום', transcription: 'леhаавӣр ташлу́м', translation: 'переводить платёж, делать перевод', partOfSpeech: 'verb', root: 'ע-ב-ר', lessonId: 14 },
      { id: 'acc_v_13', hebrew: 'לְשַׁלֵּם מִסִּים', hebrewPlain: 'לשלם מסים', transcription: 'лешалéм мисӣм', translation: 'платить налоги', partOfSpeech: 'verb', root: 'ש-ל-ם', lessonId: 48 },
      { id: 'acc_v_14', hebrew: 'לִפְתּוֹחַ תִּיק', hebrewPlain: 'לפתוח תיק', transcription: 'лифтóах тик', translation: 'открывать дело в налоговых органах', partOfSpeech: 'verb', root: 'פ-ת-ח', lessonId: 48 },
      { id: 'acc_v_15', hebrew: 'לִסְגּוֹר שָׁנָה', hebrewPlain: 'לסגור שנה', transcription: 'лисгóр шанá', translation: 'закрывать финансовый год', partOfSpeech: 'verb', root: 'ס-ג-ר', lessonId: 48 },
      { id: 'acc_v_16', hebrew: 'לְנַהֵל סְפָרִים', hebrewPlain: 'לנהל ספרים', transcription: 'ленаhéль сфарӣм', translation: 'вести бухгалтерские книги', partOfSpeech: 'verb', root: 'נ-ה-ל', lessonId: 48 },
      { id: 'acc_v_17', hebrew: 'לַעֲקוֹב אַחֲרֵי הוֹצָאוֹת', hebrewPlain: 'לעקוב אחרי הוצאות', transcription: 'лаакóв ахарéй hоцаóт', translation: 'отслеживать расходы', partOfSpeech: 'verb', root: 'ע-ק-ב', lessonId: 14 },
      { id: 'acc_v_18', hebrew: 'לִפְרוֹס תַּשְׁלוּמִים', hebrewPlain: 'לפרוס תשלומים', transcription: 'лифрóс ташлумӣм', translation: 'разбивать на платежи / рассрочку', partOfSpeech: 'verb', root: 'פ-ר-ס', lessonId: 14 },
      { id: 'acc_v_19', hebrew: 'לְבַטֵּל חֶשְׁבּוֹנִית', hebrewPlain: 'לבטל חשבונית', transcription: 'лебатéль хешбонӣт', translation: 'аннулировать счёт-фактуру', partOfSpeech: 'verb', root: 'ב-ט-ל', lessonId: 48 },
      { id: 'acc_v_20', hebrew: 'לְבַקֵּר דּוּחוֹת', hebrewPlain: 'לבקר דוחות', transcription: 'левакéр духот', translation: 'аудировать, проверять финансовые отчёты', partOfSpeech: 'verb', root: 'ב-ק-ר', lessonId: 48 },
      { id: 'acc_v_21', hebrew: 'לְהַשְׁקִיעַ', hebrewPlain: 'להשקיע', transcription: 'леhашкӣа', translation: 'инвестировать, вкладывать средства', partOfSpeech: 'verb', root: 'ש-ק-ע', lessonId: 65 },
      { id: 'acc_v_22', hebrew: 'לְהַפְרִישׁ לִפְנְסִיָּה', hebrewPlain: 'להפריש לפנסיה', transcription: 'леhафрӣш лепéнсия', translation: 'делать отчисления в пенсионный фонд', partOfSpeech: 'verb', root: 'פ-ר-ש', lessonId: 61 },
      { id: 'acc_v_23', hebrew: 'לְהַפְחִית פְּחָת', hebrewPlain: 'להפחית פחת', transcription: 'леhафхӣт пхат', translation: 'списывать амортизацию оборудования', partOfSpeech: 'verb', root: 'פ-ח-ת', lessonId: 65 },
      { id: 'acc_v_24', hebrew: 'לְהַגִּישׁ עַרְעוּר', hebrewPlain: 'להגיש ערעור', transcription: 'леhагӣш эр’ӯр', translation: 'подавать апелляцию / обжалование', partOfSpeech: 'verb', root: 'נ-ג-ש', lessonId: 87 },
      { id: 'acc_v_25', hebrew: 'לְהַסְדִּיר חוֹב', hebrewPlain: 'להסדיר חוב', transcription: 'леhасдӣр хов', translation: 'урегулировать задолженность', partOfSpeech: 'verb', root: 'ס-ד-ר', lessonId: 14 },
    ],
  },
  ...
  // ==========================================
  {
    ...
    icon: 'Users',
    words: [
      { id: 'acc_l_1', hebrew: 'נָא לְהַעֲבִיר קַבָּלוֹת עַד הַ-15 בַּחוֹדֶשׁ', hebrewPlain: 'נא להעביר קבלות עד ה-15 בחודש', transcription: 'на леhаавӣр кабалóт ад hа-хамишá-асáр бахóдеш', translation: 'Пожалуйста, передайте квитанции до 15-го числа', partOfSpeech: 'expression', lessonId: 0 },
      { id: 'acc_l_2', hebrew: 'מַגִּיעַ לְךָ הֶחְזֵר מַס מַשְׁמָעוּתִי', hebrewPlain: 'מגיע לך החזר מס משמעותי', transcription: 'магӣа лехá hехзéр мас машмаутӣ', translation: 'Вам полагается существенный возврат налога', partOfSpeech: 'expression', lessonId: 0 },
      { id: 'acc_l_3', hebrew: 'הַהוֹצָאָה הַזֹּאת אֵינָהּ מוּכֶּרֶת לְמַס', hebrewPlain: 'ההוצאה הזאת אינה מוכרת למס', transcription: 'hаhоцаá hазóт эйнá мукéрет лемáс', translation: 'Этот расход не признаётся налоговой инспекцией', partOfSpeech: 'expression', lessonId: 0 },
      { id: 'acc_l_4', hebrew: 'חֲסֵרָה לִי חֶשְׁבּוֹנִית עֲבוּר תַּשְׁלוּם זֶה', hebrewPlain: 'חסרה לי חשבונית עבור תשלום זה', transcription: 'хасерá ли хешбонӣт авӯр ташлу́м зэ', translation: 'Мне не хватает квитанции/инвойса по этому платежу', partOfSpeech: 'expression', lessonId: 0 },
      { id: 'acc_l_5', hebrew: 'צָרִיךְ לַעֲשׂוֹת תֵּיאוּם מַס עֲבוּר שְׁתֵּי עֲבוֹדוֹת', hebrewPlain: 'צריך לעשות תיאום מס עבור שתי עבודות', transcription: 'царӣх лаасóт теу́м мас авӯр штей аводóт', translation: 'Нужно сделать согласование налогов на две работы', partOfSpeech: 'expression', lessonId: 0 },
      ...
      { id: 'acc_l_7', hebrew: 'יֵשׁ לְשַׁלֵּם אֶת הַמַּעַ״מ עַד שָׁבוּעַ הַבָּא', hebrewPlain: 'יש לשלם את המע״מ עד שבוע הבא', transcription: 'йеш лешалéм эт hамáам ад шавӯа hабá', translation: 'НДС нужно оплатить до следующей недели', partOfSpeech: 'expression', lessonId: 0 },
      { id: 'acc_l_8', hebrew: 'הַאִם עָדִיף לִהְיוֹת עוֹסֵק פָּטוּר אוֹ מוּרְשֶׁה?', hebrewPlain: 'האם עדיף להיות עוסק פטור או מורשה?', transcription: 'hаим адӣф лиhйóт осéк патӯр о муршé?', translation: 'Что выгоднее: осек патур или осек мурше?', partOfSpeech: 'expression', lessonId: 0 },
      { id: 'acc_l_9', hebrew: 'הַהַכְנָסוֹת עָבְרוּ אֶת הַתִּקְרָה שֶׁל עוֹסֵק פָּטוּר', hebrewPlain: 'ההכנסות עברו את התקרה של עוסק פטור', transcription: 'hаhахнасóт аврӯ эт hатикрá шель осéк патӯр', translation: 'Доходы превысили лимит для «осек патур»', partOfSpeech: 'expression', lessonId: 0 },
      { id: 'acc_l_10', hebrew: 'תַּפְקִיד אֶת הַכֶּסֶף לְקֶרֶן הִשְׁתַּלְּמוּת', hebrewPlain: 'תפקיד את הכסף לקרן השתלמות', transcription: 'тафкӣд эт hакéсеф лекéрен hиштальмӯт', translation: 'Внесите деньги в керен иштальмут до конца года', partOfSpeech: 'expression', lessonId: 0 },
      { id: 'acc_l_11', hebrew: 'זֶה יַקְטִין אֶת תַּשְׁלוּם הַמַּס שֶׁלְּךָ', hebrewPlain: 'זה יקטין את תשלום המס שלך', transcription: 'зэ йактӣн эт ташлу́м hамáс шельхá', translation: 'Это уменьшит сумму вашего налога к уплате', partOfSpeech: 'expression', lessonId: 0 },
      { id: 'acc_l_12', hebrew: 'צָרִיךְ לְעַדְכֵּן אֶת גּוֹבַהּ הַמִּקְדָּמוֹת', hebrewPlain: 'צריך לעדכן את גובה המקדמות', transcription: 'царӣх леадкéн эт гóва hамикдамóт', translation: 'Нужно скорректировать размер налоговых авансов', partOfSpeech: 'expression', lessonId: 0 },
      ...
      { id: 'acc_l_15', hebrew: 'אֶפְשָׁר לִפְרוֹס אֶת הַחוֹב לְתַשְׁלוּמִים', hebrewPlain: 'אפשר לפרוס את החוב לתשלומים', transcription: 'эфшáр лифрóс эт hахóв леташлумӣм', translation: 'Можно разбить задолженность на платежи', partOfSpeech: 'expression', lessonId: 0 },
      { id: 'acc_l_16', hebrew: 'נָא לַחְתּוֹם עַל יִיפּוּי כּוֹחַ לָרוֹאֵה חֶשְׁבּוֹן', hebrewPlain: 'נא לחתום על ייפוי כוח לרואה חשבון', transcription: 'на лахтóм аль йипу́й кóах ларо’é хешбóн', translation: 'Пожалуйста, подпишите доверенность на бухгалтера', partOfSpeech: 'expression', lessonId: 0 },
      { id: 'acc_l_17', hebrew: 'הַשָּׂכָר נֶטּוֹ וְהַשָּׂכָר בְּרוּטוֹ', hebrewPlain: 'השכר נטו והשכר ברוטו', transcription: 'hасахáр нéто веhасахáр брӯто', translation: 'Зарплата «на руки» (нетто) и до вычетов (брутто)', partOfSpeech: 'noun', gender: 'm', root: 'ש-כ-ר', lessonId: 0 },
      { id: 'acc_l_18', hebrew: 'יֵשׁ לְךָ נְקוּדַּת זִיכּוּי נוֹסֶפֶת עַל יֶלֶד', hebrewPlain: 'יש לך נקודת זיכוי נוספת על ילד', transcription: 'йеш лехá некудáт зику́й носéфет аль йéлед', translation: 'Вам положен дополнительный налоговый балл за ребёнка', partOfSpeech: 'expression', lessonId: 0 },
      { id: 'acc_l_19', hebrew: 'מָה הָרֶוַוח הַנָּקִי הַשָּׁנָה?', hebrewPlain: 'מה הרווח הנקי השנה?', transcription: 'ма hарéвах hанакӣ hашанá?', translation: 'Какова чистая прибыль в этом году?', partOfSpeech: 'expression', lessonId: 0 },
      { id: 'acc_l_20', hebrew: 'שָׁמַרְתָּ אֶת הַקַּבָּלוֹת עַל הַדֶּלֶק?', hebrewPlain: 'שמרת את הקבלות על הדלק?', transcription: 'шамáрта эт hакабалóт аль hадéлек?', translation: 'Вы сохранили чеки на бензин?', partOfSpeech: 'expression', lessonId: 0 },
      { id: 'acc_l_21', hebrew: 'זֶה נִכְנָס תַּחַת הוֹצָאוֹת רֶכֶב', hebrewPlain: 'זה נכנס תחת הוצאות רכב', transcription: 'зэ нихнáс тáхат hоцаóт рéхев', translation: 'Это идёт по статье авторасходов', partOfSpeech: 'expression', lessonId: 0 },
      { id: 'acc_l_22', hebrew: 'הַבַּנְק מְבַקֵּשׁ אֶת הַדּוּ״חַ הַמְּבוּקָּר', hebrewPlain: 'הבנק מבקש את הדוח המבוקר', transcription: 'hабáнк мевакéш эт hадóах hамевукáр', translation: 'Банк запрашивает аудированный годовой отчёт', partOfSpeech: 'expression', lessonId: 0 },
      { id: 'acc_l_23', hebrew: 'יֵשׁ לְהַגִּישׁ אֶת הַהַצְהָרָה עַד סוֹף הַחוֹדֶשׁ', hebrewPlain: 'יש להגיש את ההצהרה עד סוף החודש', transcription: 'йеш леhагӣш эт hаhацhарá ад соф hахóдеш', translation: 'Необходимо подать декларацию до конца месяца', partOfSpeech: 'expression', lessonId: 0 },
      { id: 'acc_l_24', hebrew: 'שְׁנַת עֲסָקִים מוּצְלַחַת וּפוֹרִיָּה!', hebrewPlain: 'שנת עסקים מוצלחת ופוריה!', transcription: 'шнат асахӣм муцлáхат уфорйá!', translation: 'Успешного и прибыльного финансового года!', partOfSpeech: 'expression', lessonId: 0 },
      { id: 'acc_l_25', hebrew: 'אֲנַחְנוּ מְטַפְּלִים בְּכָל הַבֵּירוֹקְרַטְיָה', hebrewPlain: 'אנחנו מטפלים בכל הבירוקרטיה', transcription: 'анáхну метаплӣм бехóль hабюрократия', translation: 'Мы берём всю бюрократию на себя', partOfSpeech: 'expression', lessonId: 0 },
    ],
  },
];
