...
export const ACCOUNTING_DECKS: ThematicDeck[] = [
  ...
  // ==========================================
  {
    ...
    words: [
      ...
      { id: 'acc_v_2', hebrew: 'לְחַיֵּב', hebrewPlain: 'לחייב', transcription: 'лехайéв', translation: 'дебетовать, списывать со счёта, начислять к оплате', partOfSpeech: 'verb', root: 'ח-י-ב', lessonId: 0 },
      ...
      { id: 'acc_v_8', hebrew: 'לְדַוֵּחַ', hebrewPlain: 'לדווח', transcription: 'ледавéах', translation: 'подавать отчётность, декларировать', partOfSpeech: 'verb', root: 'ד-ו-ח', lessonId: 0 },
      ...
      { id: 'acc_v_11', hebrew: 'לִמְשֹׁךְ כֶּסֶף', hebrewPlain: 'למשוך כסף', transcription: 'лимшóх кéсеф', translation: 'снимать деньги со счёта', partOfSpeech: 'verb', root: 'מ-ש-ך', lessonId: 0 },
      ...
      { id: 'acc_v_14', hebrew: 'לִפְתֹּחַ תִּיק', hebrewPlain: 'לפתוח תיק', transcription: 'лифтóах тик', translation: 'открывать дело в налоговых органах', partOfSpeech: 'verb', root: 'פ-ת-ח', lessonId: 0 },
      { id: 'acc_v_15', hebrew: 'לִסְגֹּר שָׁנָה', hebrewPlain: 'לסגור שנה', transcription: 'лисгóр шанá', translation: 'закрывать финансовый год', partOfSpeech: 'verb', root: 'ס-ג-ר', lessonId: 0 },
      ...
      { id: 'acc_v_17', hebrew: 'לַעֲקֹב אַחֲרֵי הוֹצָאוֹת', hebrewPlain: 'לעקוב אחרי הוצאות', transcription: 'лаакóв ахарéй hоцаóт', translation: 'отслеживать расходы', partOfSpeech: 'verb', root: 'ע-ק-ב', lessonId: 0 },
      { id: 'acc_v_18', hebrew: 'לִפְרֹס תַּשְׁלוּמִים', hebrewPlain: 'לפרוס תשלומים', transcription: 'лифрóс ташлумӣм', translation: 'разбивать на платежи / рассрочку', partOfSpeech: 'verb', root: 'פ-ר-ס', lessonId: 0 },
  ...
  // ==========================================
  {
    ...
    words: [
      ...
      { id: 'acc_t_3', hebrew: 'בִּטּוּחַ לְאֻמִּי', hebrewPlain: 'ביטוח לאומי', transcription: 'битӯах леумӣ', translation: 'Служба национального страхования (Битуах Леуми)', partOfSpeech: 'noun', gender: 'm', root: 'ב-ט-ח', lessonId: 0 },
      ...
      { id: 'acc_t_6', hebrew: 'נִכּוּי בַּמָּקוֹר', hebrewPlain: 'ניכוי במקור', transcription: 'нику́й бамакóр', translation: 'удержание налога у источника выплаты', partOfSpeech: 'noun', gender: 'm', root: 'נ-כ-ה', lessonId: 0 },
      { id: 'acc_t_7', hebrew: 'נְקֻדּוֹת זִכּוּי', hebrewPlain: 'נקודות זיכוי', transcription: 'некудóт зику́й', translation: 'льготные налоговые баллы (скидка с налога)', partOfSpeech: 'noun', gender: 'f', root: 'ז-כ-ה', lessonId: 0 },
      ...
      { id: 'acc_t_10', hebrew: 'הוֹצָאָה מֻכֶּרֶת', hebrewPlain: 'הוצאה מוכרת', transcription: 'hоцаá мукéрет', translation: 'признанный для вычета расход бизнеса', partOfSpeech: 'noun', gender: 'f', root: 'י-צ-א', lessonId: 0 },
      ...
      { id: 'acc_t_13', hebrew: 'תֵּאוּם מַס', hebrewPlain: 'תיאום מס', transcription: 'теу́м мас', translation: 'согласование налогов (при работе на 2+ ставках)', partOfSpeech: 'noun', gender: 'm', root: 'ת-א-ם', lessonId: 0 },
      { id: 'acc_t_14', hebrew: 'קְנָס / רִבִּית פִּגּוּרִים', hebrewPlain: 'קנס', transcription: 'кнас / рибӣт пигурӣм', translation: 'штраф / пени за просрочку платежа', partOfSpeech: 'noun', gender: 'm', root: 'ק-נ-ס', lessonId: 0 },
      { id: 'acc_t_15', hebrew: 'שֻׁמַּת מַס', hebrewPlain: 'שומת מס', transcription: 'шумáт мас', translation: 'налоговое начисление / оценка инспектора', partOfSpeech: 'noun', gender: 'f', root: 'ש-ו-ם', lessonId: 0 },
      { id: 'acc_t_16', hebrew: 'פְּקִיד שֻׁמָּה', hebrewPlain: 'פקיד שומה', transcription: 'пкӣд шумá', translation: 'налоговый инспектор / чиновник мас ахнаса', partOfSpeech: 'noun', gender: 'm', root: 'פ-ק-ד', lessonId: 0 },
      ...
      { id: 'acc_t_24', hebrew: 'פִּצּוּיֵי פִּטּוּרִין', hebrewPlain: 'פיצויי פיטורין', transcription: 'пицуйéй питурӣн', translation: 'выходное пособие при увольнении', partOfSpeech: 'noun', gender: 'm', root: 'פ-צ-ה', lessonId: 0 },
  ...
  // ==========================================
  {
    ...
    words: [
      ...
      { id: 'acc_d_5', hebrew: 'הוֹדָעַת זִכּוּי', hebrewPlain: 'הודעת זיכוי', transcription: 'hодаáт зику́й', translation: 'кредит-нота, счёт возврата', partOfSpeech: 'noun', gender: 'f', root: 'ז-כ-ה', lessonId: 0 },
      ...
      { id: 'acc_d_7', hebrew: 'טֹפֶס 101', hebrewPlain: 'טופס 101', transcription: 'тóфес мéа веэхáд', translation: 'форма 101 (декларация работника при найме)', partOfSpeech: 'noun', gender: 'm', lessonId: 0 },
      { id: 'acc_d_8', hebrew: 'טֹפֶס 106', hebrewPlain: 'טופס 106', transcription: 'тóфес мéа вешéш', translation: 'форма 106 (годовая сводка зарплаты и налогов)', partOfSpeech: 'noun', gender: 'm', lessonId: 0 },
      ...
      { id: 'acc_d_10', hebrew: 'עוֹסֵק מֻרְשֶׁה', hebrewPlain: 'עוסק מורשה', transcription: 'осéк муршé', translation: 'лицензированный предприниматель (плательщик НДС)', partOfSpeech: 'noun', gender: 'm', root: 'ע-ס-ק', lessonId: 0 },
      ...
      { id: 'acc_d_12', hebrew: 'עֻמֻּתָּה', hebrewPlain: 'עמותה', transcription: 'амутá', translation: 'некоммерческая организация (НКО)', partOfSpeech: 'noun', gender: 'f', root: 'ע-מ-ת', lessonId: 0 },
      ...
      { id: 'acc_d_14', hebrew: 'דּוּ״חַ רֶוַח וְהֶפְסֵד', hebrewPlain: 'דוח רווח והפסד', transcription: 'дóах рéвах веhефсéд', translation: 'отчёт о прибылях и убытках (P&L)', partOfSpeech: 'noun', gender: 'm', lessonId: 0 },
      { id: 'acc_d_15', hebrew: 'תַּזְרִים מְזֻמָּנִים', hebrewPlain: 'תזרים מזומנים', transcription: 'тазрӣм мезуманӣм', translation: 'отчёт о движении денежных средств (Cash Flow)', partOfSpeech: 'noun', gender: 'm', root: 'ז-ר-ם', lessonId: 0 },
      ...
      { id: 'acc_d_17', hebrew: 'הִתְחַיְּבוּיוֹת', hebrewPlain: 'התחייבויות', transcription: 'hитхайвею́т', translation: 'пассивы, финансовые обязательства', partOfSpeech: 'noun', gender: 'f', root: 'ח-י-ב', lessonId: 0 },
      ...
      { id: 'acc_d_19', hebrew: 'מְזֻמָּן', hebrewPlain: 'מזומן', transcription: 'мезумáн', translation: 'наличные деньги', partOfSpeech: 'noun', gender: 'm', root: 'ז-מ-ן', lessonId: 0 },
      ...
      { id: 'acc_d_23', hebrew: 'רִבִּית', hebrewPlain: 'ריבית', transcription: 'рибӣт', translation: 'процентная ставка, проценты по займу', partOfSpeech: 'noun', gender: 'f', root: 'ר-ב-ה', lessonId: 0 },
  ...
  // ==========================================
  {
    ...
    titleHebrew: 'הַנְהָלַת חֶשְׁבּוֹנוֹת — שִׂיחָה עִם לָקוֹחַ וְרָשֻׁיּוֹת',
    ...
    icon: 'Users',
    words: [
      { id: 'acc_l_1', hebrew: 'נָא לְהַעֲבִיר קַבָּלוֹת עַד הַ-15 בַּחֹדֶשׁ', hebrewPlain: 'להעביר קבלות עד ה15', transcription: 'на леhаавӣр кабалóт ад hа-хамишá-асáр бахóдеш', translation: 'Пожалуйста, передайте квитанции до 15-го числа', partOfSpeech: 'expression', lessonId: 0 },
      ...
      { id: 'acc_l_3', hebrew: 'הַהוֹצָאָה הַזֹּאת אֵינָהּ מֻכֶּרֶת לְמַס', hebrewPlain: 'ההוצאה הזו אינה מוכרת', transcription: 'hаhоцаá hазóт эйнá мукéрет лемáс', translation: 'Этот расход не признаётся налоговой инспекцией', partOfSpeech: 'expression', lessonId: 0 },
      ...
      { id: 'acc_l_5', hebrew: 'צָרִיךְ לַעֲשׂוֹת תֵּאוּם מַס עֲבוּר שְׁתֵּי עֲבוֹדוֹת', hebrewPlain: 'תיאום מס לשתי עבודות', transcription: 'царӣх лаасóт теу́м мас авӯр штей аводóт', translation: 'Нужно сделать согласование налогов на две работы', partOfSpeech: 'expression', lessonId: 0 },
      { id: 'acc_l_6', hebrew: 'הַדּוּ״חַ הַשְּׁנָתִי הֻגַּשׁ בְּהַצְלָחָה', hebrewPlain: 'הדוח השנתי הוגש בהצלחה', transcription: 'hадóах hашнатӣ hугáш беhацлахá', translation: 'Годовой отчёт успешно отправлен в налоговую', partOfSpeech: 'expression', lessonId: 0 },
      ...
      { id: 'acc_l_8', hebrew: 'הַאִם עָדִיף לִהְיוֹת עוֹסֵק פָּטוּר אוֹ מֻרְשֶׁה?', hebrewPlain: 'עוסק פטור או מורשה?', transcription: 'hаим адӣф лиhйóт осéк патӯр о муршé?', translation: 'Что выгоднее: осек патур или осек мурше?', partOfSpeech: 'expression', lessonId: 0 },
      ...
      { id: 'acc_l_12', hebrew: 'צָרִיךְ לְעַדְכֵּן אֶת גֹּבַהּ הַמִּקְדָּמוֹת', hebrewPlain: 'לעדכן את גובה המקדמות', transcription: 'царӣх леадкéн эт гóва hамикдамóт', translation: 'Нужно скорректировать размер налоговых авансов', partOfSpeech: 'expression', lessonId: 0 },
      { id: 'acc_l_13', hebrew: 'קִבַּלְתָּ מִכְתָּב מִבִּטּוּחַ לְאֻמִּי?', hebrewPlain: 'קיבלת מכתב מביטוח לאומי?', transcription: 'кибáльта михтáв мибитӯах леумӣ?', translation: 'Вы получали письмо из Битуах Леуми?', partOfSpeech: 'expression', lessonId: 0 },
      { id: 'acc_l_14', hebrew: 'הַחֶשְׁבּוֹן שֶׁלְּךָ מְאֻזָּן לַחֲלוּטִין', hebrewPlain: 'החשבון שלך מאוזן לחלוטין', transcription: 'hахешбóн шельхá меузáн лахалутӣн', translation: 'Ваш баланс полностью сошёлся', partOfSpeech: 'expression', lessonId: 0 },
      { id: 'acc_l_15', hebrew: 'אֶפְשָׁר לִפְרֹס אֶת הַחוֹב לְתַשְׁלוּמִים', hebrewPlain: 'לפרוס את החוב', transcription: 'эфшáр лифрóс эт hахóв леташлумӣм', translation: 'Можно разбить задолженность на платежи', partOfSpeech: 'expression', lessonId: 0 },
      { id: 'acc_l_16', hebrew: 'נָא לַחְתֹּם עַל יִפּוּי כֹּחַ לָרוֹאֵה חֶשְׁבּוֹן', hebrewPlain: 'לחתום על ייפוי כוח', transcription: 'на лахтóм аль йипу́й кóах ларо’é хешбóн', translation: 'Пожалуйста, подпишите доверенность на бухгалтера', partOfSpeech: 'expression', lessonId: 0 },
      ...
      { id: 'acc_l_18', hebrew: 'יֵשׁ לְךָ נְקֻדַּת זִכּוּי נוֹסֶפֶת עַל יֶלֶד', hebrewPlain: 'נקודת זיכוי על ילד', transcription: 'йеш лехá некудáт зику́й носéфет аль йéлед', translation: 'Вам положен дополнительный налоговый балл за ребёнка', partOfSpeech: 'expression', lessonId: 0 },
      { id: 'acc_l_19', hebrew: 'מָה הָרֶוַח הַנָּקִי הַשָּׁנָה?', hebrewPlain: 'מה הרווח הנקי?', transcription: 'ма hарéвах hанакӣ hашанá?', translation: 'Какова чистая прибыль в этом году?', partOfSpeech: 'expression', lessonId: 0 },
      ...
      { id: 'acc_l_22', hebrew: 'הַבַּנְק מְבַקֵּשׁ אֶת הַדּוּ״חַ הַמְּבֻקָּר', hebrewPlain: 'דוח מבוקר לבנק', transcription: 'hабáнк мевакéш эт hадóах hамевукáр', translation: 'Банк запрашивает аудированный годовой отчёт', partOfSpeech: 'expression', lessonId: 0 },
      { id: 'acc_l_23', hebrew: 'יֵשׁ לְהַגִּישׁ אֶת הַהַצְהָרָה עַד סוֹף הַחֹדֶשׁ', hebrewPlain: 'להגיש את ההצהרה', transcription: 'йеш леhагӣш эт hаhацhарá ад соф hахóдеш', translation: 'Необходимо подать декларацию до конца месяца', partOfSpeech: 'expression', lessonId: 0 },
      { id: 'acc_l_24', hebrew: 'שְׁנַת עֲסָקִים מֻצְלַחַת וּפֹרִיָּה!', hebrewPlain: 'שנת עסקים מוצלחת!', transcription: 'шнат асахӣм муцлáхат уфорйá!', translation: 'Успешного и прибыльного финансового года!', partOfSpeech: 'expression', lessonId: 0 },
