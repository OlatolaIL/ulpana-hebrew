...
export const LIBRARIAN_DECKS: ThematicDeck[] = [
  ...
  // ==========================================
  {
    ...
    icon: 'Users',
    words: [
      { id: 'lib_d_1', hebrew: 'שָׁלוֹם, אֵיךְ אֲנִי יָכוֹל לַעֲזוֹר לְךָ לִמְצוֹא אֶת הַסֵּפֶר?', hebrewPlain: 'איך לעזור למצוא את הספר?', transcription: 'шалóм, эйх анӣ яхóль лаазóр лехá лимцó эт hасéфер?', translation: 'Здравствуйте, как я могу помочь вам найти книгу?', partOfSpeech: 'expression', lessonId: 0 },
      { id: 'lib_d_2', hebrew: 'הַסֵּפֶר נִמְצָא בַּקּוֹמָה הַשְּׁנִיָּה בְּחֲדַר הָעִיּוּן', hebrewPlain: 'הספר בקומה השנייה בחדר עיון', transcription: 'hасéфер нимцá бакомá hашнийá бехадáр hаийӯн', translation: 'Книга находится на втором этаже в читальном зале', partOfSpeech: 'expression', lessonId: 0 },
      { id: 'lib_d_3', hebrew: 'תּוּכַל לְחַפֵּשׂ בַּקָּטָלוֹג הַמְּמוּחְשָׁב לְפִי שֵׁם הַמְּחַבֵּר', hebrewPlain: 'לחפש בקטלוג לפי שם המחבר', transcription: 'тухáль лехапéс бакаталóг hамемухшáв лефӣ шем hамехабéр', translation: 'Вы можете найти издание в электронном каталоге по автору', partOfSpeech: 'expression', lessonId: 0 },
      { id: 'lib_d_4', hebrew: 'אֶפְשָׁר לְהַאֲרִיךְ אֶת הַהַשְׁאָלָה בְּעוֹד שְׁבוּעַיִם?', hebrewPlain: 'להאריך את ההשאלה בעוד שבועיים', transcription: 'эфшáр леhаарӣх эт hаhаш’алá беóд швуáйим?', translation: 'Можно ли продлить абонемент ещё на две недели?', partOfSpeech: 'expression', lessonId: 0 },
      { id: 'lib_d_5', hebrew: 'הַסֵּפֶר מֻשְׁאָל כָּרֶגַע, רוֹצֶה לְהַזְמִין תּוֹר?', hebrewPlain: 'הספר מושאל, להזמין תור?', transcription: 'hасéфер муш’áль карéга, роцé леhазмӣн тор?', translation: 'Книга сейчас выдана, хотите встать в очередь ожидания?', partOfSpeech: 'expression', lessonId: 0 },
      { id: 'lib_d_6', hebrew: 'יֵשׁ לָנוּ גַּם גִּרְסָה דִּיגִיטָלִית שֶׁל הַסֵּפֶר הַזֶּה', hebrewPlain: 'גרסה דיגיטלית של הספר', transcription: 'йеш лáну гам гирсá дигитáлит шель hасéфер hазé', translation: 'У нас также есть электронная версия этой книги', partOfSpeech: 'expression', lessonId: 0 },
      { id: 'lib_d_7', hebrew: 'סְלִיחָה, נָא לִשְׁמוֹר עַל הַשֶּׁקֶט בַּסִּפְרִיָּה', hebrewPlain: 'נא לשמור על השקט בספריה', transcription: 'слихá, на лишмóр аль hашéкет басифрийá', translation: 'Извините, пожалуйста, соблюдайте тишину в библиотеке', partOfSpeech: 'expression', lessonId: 0 },
      { id: 'lib_d_8', hebrew: 'כְּדֵי לִפְתּוֹחַ כַּרְטִיס קוֹרֵא צָרִיךְ תְּעוּדַת זֶהוּת', hebrewPlain: 'לפתוח כרטיס קורא עם תעודת זהות', transcription: 'кдей лифтóах картӣс корé царӣх теудáт зеhӯт', translation: 'Для открытия читательского билета нужен теудат-зеут', partOfSpeech: 'expression', lessonId: 0 },
      { id: 'lib_d_9', hebrew: 'אֵיפֹה נִמְצֵאת מַחְלֶקֶת כִּתְבֵי הָעֵת?', hebrewPlain: 'איפה מחלקת כתבי העת?', transcription: 'э́йфо нимцéт махлéкет китвéй hаэ́т?', translation: 'Где находится отдел периодических изданий?', partOfSpeech: 'expression', lessonId: 0 },
      { id: 'lib_d_10', hebrew: 'הַתִּיק הַזֶּה שָׁמוּר בְּאַרְכִיּוֹן וְדוֹרֵשׁ הַזְמָנָה מֵרֹאשׁ', hebrewPlain: 'התיק שמור בארכיון ודורש הזמנה מראש', transcription: 'hатӣк hазé шамӯр беархийóн ведорéш hазманá мерóш', translation: 'Это дело хранится в архиве и требует предварительного заказа', partOfSpeech: 'expression', lessonId: 0 },
      { id: 'lib_d_11', hebrew: 'יֵשׁ לַעֲטוֹת כְּפָפוֹת לִפְנֵי נְגִיעָה בִּכְתַב הַיָּד הַנָּדִיר', hebrewPlain: 'לעטות כפפות לפני נגיעה בכתב היד', transcription: 'йеш лаатóт кфафóт лифнéй негиá бихтав hайáд hанадӣр', translation: 'Необходимо надеть перчатки перед работой с редкой рукописью', partOfSpeech: 'expression', lessonId: 0 },
      { id: 'lib_d_12', hebrew: 'הַאִם מֻתָּר לְצַלֵּם אוֹ לִסְרוֹק אֶת הַמִּסְמָךְ?', hebrewPlain: 'מותר לצלם או לסרוק את המסמך?', transcription: 'hаӣм мутáр лецалéм о лисрóк эт hамисмáх?', translation: 'Разрешено ли фотографировать или сканировать этот документ?', partOfSpeech: 'expression', lessonId: 0 },
      ...
      { id: 'lib_d_15', hebrew: 'מָתַי צָרִיךְ לְהַחְזִיר אֶת הַסְּפָרִים?', hebrewPlain: 'מתי להחזיר את הספרים?', transcription: 'матáй царӣх леhахзӣр эт hасфарӣм?', translation: 'Когда наступает крайний срок возврата книг?', partOfSpeech: 'expression', lessonId: 0 },
      { id: 'lib_d_16', hebrew: 'יֵשׁ לְךָ קְנָס קָטָן עַל אִחוּר בַּהַחְזָרָה', hebrewPlain: 'קנס על איחור בהחזרה', transcription: 'йеш лехá кнас катáн аль ихӯр баhахзарá', translation: 'У вас небольшой штраф за задержку сдачи книг', partOfSpeech: 'expression', lessonId: 0 },
      { id: 'lib_d_17', hebrew: 'אֶפְשָׁר לְהַזְמִין אֶת הַסֵּפֶר בְּהַשְׁאָלָה בֵּין-סִפְרִיָּתִית', hebrewPlain: 'להזמין בהשאלה בין-ספרייתית', transcription: 'эфшáр леhазмӣн эт hасéфер беhаш’алá бейн-сифрийатӣт', translation: 'Можно заказать книгу через межбиблиотечный абонемент', partOfSpeech: 'expression', lessonId: 0 },
      { id: 'lib_d_18', hebrew: 'סִפְרֵי עִיּוּן וּמִלּוֹנִים אֵינָם לְהַשְׁאָלָה הַבַּיְתָה', hebrewPlain: 'ספרי עיון אינם להשאלה הביתה', transcription: 'сифрéй ийӯн умилонӣм эйнáм леhаш’алá hабáйта', translation: 'Справочные издания и словари на дом не выдаются', partOfSpeech: 'expression', lessonId: 0 },
      { id: 'lib_d_19', hebrew: 'תּוּכַל לְהַדְפִּיס אֶת הַמַּאֲמָר בַּמַּדְפֶּסֶת הַצִּיבּוּרִית', hebrewPlain: 'להדפיס את המאמר במדפסת', transcription: 'тухáль леhадпӣс эт hамаамáр бамадпéсет hацибурӣт', translation: 'Вы можете распечатать статью на общественном принтере', partOfSpeech: 'expression', lessonId: 0 },
      { id: 'lib_d_20', hebrew: 'אָנוּ מְבַצְּעִים פְּרוֹיֶקְט דִּיגִיטַצְיָה שֶׁל תַּצְלוּמִים הִיסְטוֹרִיִּים', hebrewPlain: 'פרויקט דיגיטציה של תצלומים', transcription: 'áну мевацъӣм проéкт дигитáция шель тацлумӣм hисторӣйим', translation: 'Мы ведём проект оцифровки исторического фотоархива', partOfSpeech: 'expression', lessonId: 0 },
      { id: 'lib_d_21', hebrew: 'הַסֵּפֶר נִפְגַּם, נַעֲבִיר אוֹתוֹ לְשִׁיקוּם וּכְרִיכָה', hebrewPlain: 'הספר נפגם, לשיקום וכריכה', transcription: 'hасéфер нифгáм, наавӣр отó лешикӯм ухрихá', translation: 'Книга повреждена, мы передадим её в переплётную мастерскую', partOfSpeech: 'expression', lessonId: 0 },
      { id: 'lib_d_22', hebrew: 'הִנֵּה הַשִּׁיפְר שֶׁל הַסֵּפֶר — זֶה הַמִּקּוּם שֶׁלּוֹ עַל הַמַּדָּף', hebrewPlain: 'שיפר הספר - מיקום על המדף', transcription: 'hинé hашӣфр шель hасéфер — зэ hамикӯм шелó аль hамадáф', translation: 'Вот шифр издания — по нему книга стоит на полке', partOfSpeech: 'expression', lessonId: 0 },
      { id: 'lib_d_23', hebrew: 'בָּאַרְכִיּוֹן יֵשׁ לְמַלֵּא טוֹפֶס בַּקָּשַׁת עִיּוּן', hebrewPlain: 'למלא טופס בקשת עיון', transcription: 'баархийóн йеш лемалé тóфес бакашáт ийӯн', translation: 'В архиве требуется заполнить бланк запроса на ознакомление', partOfSpeech: 'expression', lessonId: 0 },
      { id: 'lib_d_24', hebrew: 'כָּל הַמֵּידָע שָׁמוּר וּמְגוּבֶּה בְּשָׂרָת מְאוּבְטָח', hebrewPlain: 'כל המידע שמור ומגובה', transcription: 'коль hамейдá шамӯр умегубé бесарáт меувтáх', translation: 'Все материалы сохранены и скопированы на защищённый сервер', partOfSpeech: 'expression', lessonId: 0 },
      { id: 'lib_d_25', hebrew: 'עֲבוֹדַת הַמֶּחְקָר שֶׁלְּךָ מְרַתֶּקֶת, בְּהַצְלָחָה!', hebrewPlain: 'עבודת המחקר מרתקת, בהצלחה!', transcription: 'аводáт hамехкáр шельхá мератéкет, беhацлахá!', translation: 'Ваша исследовательская тема очень интересна, успехов!', partOfSpeech: 'expression', lessonId: 0 },
    ],
  },
];
