...
export const LIBRARIAN_DECKS: ThematicDeck[] = [
  ...
  // ==========================================
  {
    ...
    icon: 'BookMarked',
    words: [
      { id: 'lib_v_1', hebrew: 'לְקַטְלֵג', hebrewPlain: 'לקטלג', transcription: 'лекатлéг', translation: 'каталогизировать, вносить в каталог', partOfSpeech: 'verb', root: 'ק-ט-ל-ג', lessonId: 8 },
      { id: 'lib_v_2', hebrew: 'לְמַפְתֵּחַ', hebrewPlain: 'לפתח', transcription: 'лемафтéах', translation: 'индексировать, составлять предметный указатель', partOfSpeech: 'verb', root: 'מ-פ-ת-ח', lessonId: 8 },
      { id: 'lib_v_3', hebrew: 'לְמַיֵּין', hebrewPlain: 'למיין', transcription: 'лемайéн', translation: 'сортировать, классифицировать фонды', partOfSpeech: 'verb', root: 'מ-י-ן', lessonId: 8 },
      { id: 'lib_v_4', hebrew: 'לְהַשְׁאִיל', hebrewPlain: 'להשאיל', transcription: 'леhаш’ӣль', translation: 'выдавать на дом, ссужать (книгу)', partOfSpeech: 'verb', root: 'ש-א-ל', lessonId: 8 },
      { id: 'lib_v_5', hebrew: 'לְהַחְזִיר', hebrewPlain: 'להחזיר', transcription: 'леhахзӣр', translation: 'возвращать (книгу в библиотеку)', partOfSpeech: 'verb', root: 'ח-ז-р', lessonId: 8 },
      { id: 'lib_v_6', hebrew: 'לְהַזְמִין', hebrewPlain: 'להזמין', transcription: 'леhазмӣн', translation: 'заказывать (из хранилища или по МБА)', partOfSpeech: 'verb', root: 'ז-מ-ן', lessonId: 8 },
      { id: 'lib_v_7', hebrew: 'לְהַאֲרִיךְ', hebrewPlain: 'להאריך', transcription: 'леhаарӣх', translation: 'продлевать (срок пользования книгой)', partOfSpeech: 'verb', root: 'א-ר-ך', lessonId: 8 },
      { id: 'lib_v_8', hebrew: 'לְעַיֵּין', hebrewPlain: 'לעיין', transcription: 'леайéн', translation: 'просматривать, изучать в читальном зале', partOfSpeech: 'verb', root: 'ע-י-ן', lessonId: 8 },
      { id: 'lib_v_9', hebrew: 'לְאַתֵּר', hebrewPlain: 'לאתר', transcription: 'леатéр', translation: 'отыскивать, находить по шифру в фонде', partOfSpeech: 'verb', root: 'א-ת-ר', lessonId: 8 },
      { id: 'lib_v_10', hebrew: 'לְשַׁמֵּר', hebrewPlain: 'לשמר', transcription: 'лешамéр', translation: 'сохранять, консервировать редкие книги', partOfSpeech: 'verb', root: 'ש-מ-ר', lessonId: 47 },
      { id: 'lib_v_11', hebrew: 'לְשַׁקֵּם', hebrewPlain: 'לשקם', transcription: 'лешакéм', translation: 'реставрировать повреждённый документ/том', partOfSpeech: 'verb', root: 'ש-ק-ם', lessonId: 47 },
      { id: 'lib_v_12', hebrew: 'לִסְרוֹק', hebrewPlain: 'לסרוק', transcription: 'лисрóк', translation: 'сканировать', partOfSpeech: 'verb', root: 'ס-ר-ק', lessonId: 47 },
      { id: 'lib_v_13', hebrew: 'לְדַגְטֵל', hebrewPlain: 'לדגטל', transcription: 'ледагтéль', translation: 'оцифровывать (тексты, фото, плёнки)', partOfSpeech: 'verb', root: 'ד-ג-ט-ל', lessonId: 47 },
      { id: 'lib_v_14', hebrew: 'לִגְנוֹז', hebrewPlain: 'לגנוז', transcription: 'лигнóз', translation: 'помещать в архив/спецхран, архивировать', partOfSpeech: 'verb', root: 'ג-נ-ז', lessonId: 47 },
      { id: 'lib_v_15', hebrew: 'לִכְרוֹךְ', hebrewPlain: 'לכרוך', transcription: 'лихрóх', translation: 'переплетать книгу или периодику', partOfSpeech: 'verb', root: 'כ-ר-ך', lessonId: 8 },
      { id: 'lib_v_16', hebrew: 'לְתַעֵד', hebrewPlain: 'לתעד', transcription: 'летаéд', translation: 'документировать, протоколировать', partOfSpeech: 'verb', root: 'ת-ע-ד', lessonId: 48 },
      { id: 'lib_v_17', hebrew: 'לִרְשׁוֹם', hebrewPlain: 'לרשום', transcription: 'лиршóм', translation: 'регистрировать, вносить запись в реестр', partOfSpeech: 'verb', root: 'ר-ש-ם', lessonId: 8 },
      { id: 'lib_v_18', hebrew: 'לִשְׁלוֹף', hebrewPlain: 'לשלוף', transcription: 'лишлóф', translation: 'извлекать (дело из фонда / запись из БД)', partOfSpeech: 'verb', root: 'ש-ל-ף', lessonId: 8 },
      { id: 'lib_v_19', hebrew: 'לְסַוֵּוג', hebrewPlain: 'לסווג', transcription: 'лесавéг', translation: 'классифицировать (по системе / по доступу)', partOfSpeech: 'verb', root: 'ס-ו-ג', lessonId: 8 },
      { id: 'lib_v_20', hebrew: 'לְהַנְפִיק', hebrewPlain: 'להנפיק', transcription: 'леhанфӣк', translation: 'оформлять / выпускать (читательский билет)', partOfSpeech: 'verb', root: 'נ-פ-ק', lessonId: 8 },
      { id: 'lib_v_21', hebrew: 'לִגְרוֹעַ', hebrewPlain: 'לגרוע', transcription: 'лигрóа', translation: 'списывать ветхие книги из инвентаря', partOfSpeech: 'verb', root: 'ג-ר-ע', lessonId: 8 },
      { id: 'lib_v_22', hebrew: 'לְבַעֵר', hebrewPlain: 'לבער', transcription: 'леваéр', translation: 'утилизировать документы по акту списания', partOfSpeech: 'verb', root: 'ב-ע-ר', lessonId: 8 },
      { id: 'lib_v_23', hebrew: 'לְסַדֵּר', hebrewPlain: 'לסדר', transcription: 'лесадéр', translation: 'расставлять книги по полкам', partOfSpeech: 'verb', root: 'ס-ד-ר', lessonId: 8 },
      { id: 'lib_v_24', hebrew: 'לְהַדְפִּיס', hebrewPlain: 'להדפיס', transcription: 'леhадпӣс', translation: 'распечатывать материалы, формуляры', partOfSpeech: 'verb', root: 'ד-פ-ס', lessonId: 8 },
      { id: 'lib_v_25', hebrew: 'לִגְבּוֹת קְנָס', hebrewPlain: 'לגבות קנס', transcription: 'лигбóт кнас', translation: 'взимать штраф за задержку сдачи книги', partOfSpeech: 'verb', root: 'ג-ב-ה', lessonId: 8 },
    ],
  },
  ...
  // ==========================================
  {
    ...
    words: [
      ...
      { id: 'lib_d_5', hebrew: 'הַסֵּפֶר מוּשְׁאָל כָּרֶגַע, רוֹצֶה לְהַזְמִין תּוֹר?', hebrewPlain: 'הספר מושאל כרגע, רוצה להזמין תור?', transcription: 'hасéфер муш’áль карéга, роцé леhазмӣн тор?', translation: 'Книга сейчас выдана, хотите встать в очередь ожидания?', partOfSpeech: 'expression', lessonId: 0 },
      ...
      { id: 'lib_d_12', hebrew: 'הַאִם מוּתָּר לְצַלֵּם אוֹ לִסְרוֹק אֶת הַמִּסְמָךְ?', hebrewPlain: 'האם מותר לצלם או לסרוק את המסמך?', transcription: 'hаӣм мутáр лецалéм о лисрóк эт hамисмáх?', translation: 'Разрешено ли фотографировать или сканировать этот документ?', partOfSpeech: 'expression', lessonId: 0 },
      { id: 'lib_d_13', hebrew: 'הַחוֹמֶר פָּתוּחַ לְעִיּוּן חוֹקְרִים בִּלְבַד', hebrewPlain: 'החומר פתוח לעיון חוקרים בלבד', transcription: 'hахóмер патӯах леийӯн хокрӣм бильвáд', translation: 'Материал открыт для ознакомления только исследователям', partOfSpeech: 'expression', lessonId: 0 },
