...
export const DOCTOR_DECKS: ThematicDeck[] = [
  ...
  // ==========================================
  {
    ...
    words: [
      ...
      { id: 'doc_t_6', hebrew: 'תִּשְׁכַּב עַל מִיטַּת הַבְּדִיקָה', hebrewPlain: 'תשכב על המיטה', transcription: 'тишкáв аль митáт hабдикá', translation: 'Ложитесь на смотровую кушетку', partOfSpeech: 'expression', lessonId: 0 },
      ...
      { id: 'doc_t_11', hebrew: 'לָקַחַת כַּדּוּר אֶחָד פַּעֲמַיִּים בְּיוֹם', hebrewPlain: 'לקחת כדור פעמיים ביום', transcription: 'лакáхат кадӯр эхáд паамáим бейóм', translation: 'Принимать одну таблетку два раза в день', partOfSpeech: 'expression', lessonId: 0 },
      ...
      { id: 'doc_t_13', hebrew: 'תִּישָּׁאֵר בַּמִּיטָּה שְׁלוֹשָׁה יָמִים', hebrewPlain: 'תישאר במיטה', transcription: 'тиша’éр бамитá шлошá ямӣм', translation: 'Оставайтесь в постели три дня', partOfSpeech: 'expression', lessonId: 0 },
      ...
      { id: 'doc_t_16', hebrew: 'אִם הַחוֹם לֹא יוֹרֵד, תִּגַּשׁ לַמִּיּוּן', hebrewPlain: 'אם החום לא יורד', transcription: 'им hахом ло йорéд, тигáш ламиюн', translation: 'Если температура не падает, обратитесь в приёмный покой', partOfSpeech: 'expression', lessonId: 0 },
      ...
      { id: 'doc_t_19', hebrew: 'הַכּוֹל יִהְיֶה בְּסֵדֶר, אַל תִּדְאַג', hebrewPlain: 'הכל יהיה בסדר', transcription: 'hакóль йиhйé бесéдер, аль тид’áг', translation: 'Всё будет хорошо, не переживайте', partOfSpeech: 'expression', lessonId: 0 },
      ...
      { id: 'doc_t_22', hebrew: 'הַתְּרוּפָה עִם אוֹכֶל אוֹ עַל קֵיבָה רֵיקָה?', hebrewPlain: 'התרופה עם אוכל?', transcription: 'hатруфá им óхель о аль кейвá рейкá?', translation: 'Лекарство принимать с едой или натощак?', partOfSpeech: 'expression', lessonId: 0 },
      ...
      { id: 'doc_t_24', hebrew: 'לַחְבּוֹשׁ אֶת הַפֶּצַע כָּל יוֹם', hebrewPlain: 'לחבוש את הפצע', transcription: 'лахбóш эт hапéца коль йом', translation: 'Делать перевязку раны каждый день', partOfSpeech: 'expression', lessonId: 0 },
