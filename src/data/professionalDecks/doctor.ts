 ...
 *
 * ВРАЧ И ПОЛИКЛИНИКА (רוֹפֵא וּמִרְפָּאָה / קוּפַּת חוֹלִים)
 *
 * Колоды:
...
export const DOCTOR_DECKS: ThematicDeck[] = [
  ...
  // ==========================================
  {
    ...
    icon: 'Stethoscope',
    words: [
      { id: 'doc_v_1', hebrew: 'לִבְדּוֹק', hebrewPlain: 'לבדוק', transcription: 'ливдóк', translation: 'осматривать, проверять', partOfSpeech: 'verb', root: 'ב-ד-ק', lessonId: 23 },
      { id: 'doc_v_2', hebrew: 'לְאַבְחֵן', hebrewPlain: 'לאבחן', transcription: 'леавхéн', translation: 'диагностировать, ставить диагноз', partOfSpeech: 'verb', root: 'א-ב-ח-ן', lessonId: 79 },
      { id: 'doc_v_3', hebrew: 'לִרְשׁוֹם', hebrewPlain: 'לרשום', transcription: 'лиршóм', translation: 'выписывать (рецепт), записывать', partOfSpeech: 'verb', root: 'ר-ש-ם', lessonId: 23 },
      { id: 'doc_v_4', hebrew: 'לְהַפְנוֹת', hebrewPlain: 'להפנות', transcription: 'леhафнóт', translation: 'направлять (на анализы / к специалисту)', partOfSpeech: 'verb', root: 'פ-נ-ה', lessonId: 23 },
      { id: 'doc_v_5', hebrew: 'לְחַטֵּא', hebrewPlain: 'לחטא', transcription: 'лехатé', translation: 'дезинфицировать, обеззараживать', partOfSpeech: 'verb', root: 'ח-ט-א', lessonId: 46 },
      { id: 'doc_v_6', hebrew: 'לַחְבּוֹשׁ', hebrewPlain: 'לחבוש', transcription: 'лахбóш', translation: 'бинтовать, накладывать повязку', partOfSpeech: 'verb', root: 'ח-ב-ש', lessonId: 46 },
      { id: 'doc_v_7', hebrew: 'לְנַתֵּחַ', hebrewPlain: 'לנתח', transcription: 'ленатéах', translation: 'оперировать (хирургически)', partOfSpeech: 'verb', root: 'נ-ת-ח', lessonId: 79 },
      { id: 'doc_v_8', hebrew: 'לִמְדוֹד', hebrewPlain: 'למדוד', transcription: 'лимдóд', translation: 'измерять (давление, температуру)', partOfSpeech: 'verb', root: 'מ-ד-ד', lessonId: 23 },
      { id: 'doc_v_9', hebrew: 'לְהַקְשִׁיב', hebrewPlain: 'להקשיב', transcription: 'леhакшӣв', translation: 'слушать (стетоскопом лёгкие / сердце)', partOfSpeech: 'verb', root: 'ק-ש-ב', lessonId: 23 },
      { id: 'doc_v_10', hebrew: 'לְהַזְרִיק', hebrewPlain: 'להזריק', transcription: 'леhазрӣк', translation: 'делать укол, вводить инъекцию', partOfSpeech: 'verb', root: 'ז-ר-ק', lessonId: 46 },
      { id: 'doc_v_11', hebrew: 'לְהַרְדִּים', hebrewPlain: 'להרדים', transcription: 'леhардӣм', translation: 'вводить наркоз, усыплять, анестезировать', partOfSpeech: 'verb', root: 'ר-ד-ם', lessonId: 79 },
      { id: 'doc_v_12', hebrew: 'לְהַחְלִים', hebrewPlain: 'להחלים', transcription: 'леhахлӣм', translation: 'выздоравливать, поправляться', partOfSpeech: 'verb', root: 'ח-ל-ם', lessonId: 23 },
      { id: 'doc_v_13', hebrew: 'לְהִתְאוֹשֵׁשׁ', hebrewPlain: 'להתאושש', transcription: 'леhит’ошéш', translation: 'приходить в себя, восстанавливаться', partOfSpeech: 'verb', root: 'א-ו-ש', lessonId: 23 },
      { id: 'doc_v_14', hebrew: 'לְהָקֵל', hebrewPlain: 'להקל', transcription: 'леhакéль', translation: 'облегчать (боль, симптомы)', partOfSpeech: 'verb', root: 'ק-ל-ל', lessonId: 46 },
      { id: 'doc_v_15', hebrew: 'לְהַחְמִיר', hebrewPlain: 'להחמיר', transcription: 'леhахмӣр', translation: 'ухудшаться, обостряться', partOfSpeech: 'verb', root: 'ח-מ-ר', lessonId: 79 },
      { id: 'doc_v_16', hebrew: 'לְהִשְׁתַּעֵל', hebrewPlain: 'להשתעל', transcription: 'леhишта’éль', translation: 'кашлять', partOfSpeech: 'verb', root: 'ש-ע-ל', lessonId: 23 },
      { id: 'doc_v_17', hebrew: 'לְהַקִּיא', hebrewPlain: 'להקיא', transcription: 'леhакӣ', translation: 'рвать, иметь рвоту', partOfSpeech: 'verb', root: 'ק-ו-א', lessonId: 23 },
      { id: 'doc_v_18', hebrew: 'לְהִתְעַלֵּף', hebrewPlain: 'להתעלף', transcription: 'леhит’алéф', translation: 'падать в обморок, терять сознание', partOfSpeech: 'verb', root: 'ע-ל-ף', lessonId: 46 },
      { id: 'doc_v_19', hebrew: 'לִנְשׁוֹם', hebrewPlain: 'לנשום', transcription: 'линшóм', translation: 'дышать', partOfSpeech: 'verb', root: 'נ-ש-ם', lessonId: 23 },
      { id: 'doc_v_20', hebrew: 'לִבְלוֹעַ', hebrewPlain: 'לבלוע', transcription: 'ливлóа', translation: 'глотать (таблетку, капсулу)', partOfSpeech: 'verb', root: 'ב-ל-ע', lessonId: 46 },
      { id: 'doc_v_21', hebrew: 'לְאַשְׁפֵּז', hebrewPlain: 'לאשפז', transcription: 'леашпéз', translation: 'госпитализировать, класть в стационар', partOfSpeech: 'verb', root: 'א-ש-פ-ז', lessonId: 79 },
      { id: 'doc_v_22', hebrew: 'לְשַׁחְרֵר', hebrewPlain: 'לשחרר', transcription: 'лешахрéр', translation: 'выписывать из больницы, отпускать', partOfSpeech: 'verb', root: 'ש-ח-ר-ר', lessonId: 79 },
      { id: 'doc_v_23', hebrew: 'לְמַשֵּׁשׁ', hebrewPlain: 'למשש', transcription: 'лемашéш', translation: 'пальпировать, прощупывать', partOfSpeech: 'verb', root: 'מ-ש-ש', lessonId: 79 },
      { id: 'doc_v_24', hebrew: 'לִסְבּוֹל', hebrewPlain: 'לסבול', transcription: 'лисбóль', translation: 'страдать (от болезни, боли)', partOfSpeech: 'verb', root: 'ס-ב-ל', lessonId: 23 },
      { id: 'doc_v_25', hebrew: 'לְהַדְבִּיק', hebrewPlain: 'להדביק', transcription: 'леhадбӣк', translation: 'заражать (инфекцией)', partOfSpeech: 'verb', root: 'ד-ב-ק', lessonId: 23 },
    ],
  },
  ...
  // ==========================================
  {
    ...
    words: [
      ...
      { id: 'doc_t_11', hebrew: 'לָקַחַת כַּדּוּר אֶחָד פַּעֲמַיִּים בְּיוֹם', hebrewPlain: 'לקחת כדור אחד פעמיים ביום', transcription: 'лакáхат кадӯр эхáд паамáйим бейóм', translation: 'Принимать одну таблетку два раза в день', partOfSpeech: 'expression', lessonId: 0 },
      { id: 'doc_t_12', hebrew: 'חָשׁוּב לִשְׁתּוֹת הַרְבֵּה מַיִם', hebrewPlain: 'חשוב לשתות הרבה מים', transcription: 'хашу́в лиштот hарбé мáйим', translation: 'Важно пить много воды', partOfSpeech: 'expression', lessonId: 0 },
