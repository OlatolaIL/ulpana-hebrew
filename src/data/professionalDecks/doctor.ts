...
export const DOCTOR_DECKS: ThematicDeck[] = [
  ...
  // ==========================================
  {
    ...
    titleHebrew: 'רוֹפֵא — פְּעָלִים שֶׁל בְּדִיקָה וְטִפּוּל',
    ...
    icon: 'Stethoscope',
    words: [
      { id: 'doc_v_1', hebrew: 'לִבְדֹּק', hebrewPlain: 'לבדוק', transcription: 'ливдóк', translation: 'осматривать, проверять', partOfSpeech: 'verb', root: 'ב-ד-ק', lessonId: 0 },
      ...
      { id: 'doc_v_3', hebrew: 'לִרְשֹׁם', hebrewPlain: 'לרשום', transcription: 'лиршóм', translation: 'выписывать (рецепт), записывать', partOfSpeech: 'verb', root: 'ר-ש-ם', lessonId: 0 },
      ...
      { id: 'doc_v_6', hebrew: 'לַחְבֹּשׁ', hebrewPlain: 'לחבוש', transcription: 'лахбóш', translation: 'бинтовать, накладывать повязку', partOfSpeech: 'verb', root: 'ח-ב-ש', lessonId: 0 },
      ...
      { id: 'doc_v_8', hebrew: 'לִמְדֹּד', hebrewPlain: 'למדוד', transcription: 'лимдóд', translation: 'измерять (давление, температуру)', partOfSpeech: 'verb', root: 'מ-ד-ד', lessonId: 0 },
      ...
      { id: 'doc_v_19', hebrew: 'לִנְשֹׁם', hebrewPlain: 'לנשום', transcription: 'линшóм', translation: 'дышать', partOfSpeech: 'verb', root: 'נ-ש-ם', lessonId: 0 },
      { id: 'doc_v_20', hebrew: 'לִבְלֹעַ', hebrewPlain: 'לבלוע', transcription: 'ливлóа', translation: 'глотать (таблетку, капсулу)', partOfSpeech: 'verb', root: 'ב-ל-ע', lessonId: 0 },
      ...
      { id: 'doc_v_24', hebrew: 'לִסְבֹּל', hebrewPlain: 'לסבול', transcription: 'лисбóль', translation: 'страдать (от болезни, боли)', partOfSpeech: 'verb', root: 'ס-ב-ל', lessonId: 0 },
  ...
  // ==========================================
  {
    ...
    words: [
      ...
      { id: 'doc_d_2', hebrew: 'דַּלֶּקֶת רֵאוֹת', hebrewPlain: 'דלקת ריאות', transcription: 'далéкет реóт', translation: 'пневмония, воспаление лёгких', partOfSpeech: 'noun', gender: 'f', lessonId: 0 },
      ...
      { id: 'doc_d_6', hebrew: 'זִהוּם', hebrewPlain: 'זיהום', transcription: 'зиhӯм', translation: 'инфекция, заражение', partOfSpeech: 'noun', gender: 'm', root: 'ז-ה-ם', lessonId: 0 },
      { id: 'doc_d_7', hebrew: 'חֹם גָּבוֹהַּ', hebrewPlain: 'חום גבוה', transcription: 'хом гавóа', translation: 'высокая температура, жар', partOfSpeech: 'noun', gender: 'm', root: 'ח-מ-מ', lessonId: 0 },
      ...
      { id: 'doc_d_11', hebrew: 'סֻכֶּרֶת', hebrewPlain: 'סוכרת', transcription: 'сукéрет', translation: 'сахарный диабет', partOfSpeech: 'noun', gender: 'f', root: 'ס-כ-ר', lessonId: 0 },
      ...
      { id: 'doc_d_15', hebrew: 'קֹצֶר נְשִׁימָה', hebrewPlain: 'קוצר נשימה', transcription: 'кóцер нешимá', translation: 'одышка, затруднённое дыхание', partOfSpeech: 'noun', gender: 'm', root: 'ק-צ-ר', lessonId: 0 },
      { id: 'doc_d_16', hebrew: 'סְחַרְחֹרֶת', hebrewPlain: 'סחרחורת', transcription: 'схархóрет', translation: 'головокружение', partOfSpeech: 'noun', gender: 'f', root: 'ס-ח-ר', lessonId: 0 },
      ...
      { id: 'doc_d_20', hebrew: 'כְּוִיָּה', hebrewPlain: 'כוויה', transcription: 'квия', translation: 'ожог', partOfSpeech: 'noun', gender: 'f', root: 'כ-ו-ה', lessonId: 0 },
      ...
      { id: 'doc_d_24', hebrew: 'הַרְעָלַת קֵבָה', hebrewPlain: 'הרעלת קיבה', transcription: 'hаргалáт кейвá', translation: 'пищевое отравление', partOfSpeech: 'noun', gender: 'f', root: 'ר-ע-ל', lessonId: 0 },
  ...
  // ==========================================
  {
    ...
    words: [
      ...
      { id: 'doc_p_3', hebrew: 'צִלּוּם רֶנְטְגֶּן', hebrewPlain: 'צילום רנטגן', transcription: 'цилу́м рéнтген', translation: 'рентгеновский снимок', partOfSpeech: 'noun', gender: 'm', root: 'צ-ל-ם', lessonId: 0 },
      ...
      { id: 'doc_p_11', hebrew: 'קֻפַּת חוֹלִים', hebrewPlain: 'קופת חולים', transcription: 'купáт холӣм', translation: 'больничная касса (Клалит, Маккаби...)', partOfSpeech: 'noun', gender: 'f', lessonId: 0 },
      ...
      { id: 'doc_p_18', hebrew: 'חִסּוּן', hebrewPlain: 'חיסון', transcription: 'хису́н', translation: 'вакцина, прививка', partOfSpeech: 'noun', gender: 'm', root: 'ח-ס-ן', lessonId: 0 },
      ...
      { id: 'doc_p_23', hebrew: 'חַדְרֵי נִתּוּחַ', hebrewPlain: 'חדר ניתוח', transcription: 'хадáр нитӯах', translation: 'операционная', partOfSpeech: 'noun', gender: 'm', root: 'נ-ת-ח', lessonId: 0 },
  ...
  // ==========================================
  {
    ...
    icon: 'Users',
    words: [
      { id: 'doc_t_1', hebrew: 'בַּמֶּה אוּכַל לַעֲזֹר לְךָ?', hebrewPlain: 'במה אוכל לעזור לך?', transcription: 'бамé ухáль лаазóр лехá?', translation: 'Чем я могу вам помочь?', partOfSpeech: 'expression', lessonId: 0 },
      ...
      { id: 'doc_t_4', hebrew: 'תִּנְשֹׁם עָמֹק וְתַחֲזִיק', hebrewPlain: 'תנשום עמוק ותחזיק', transcription: 'тиншóм амóк ветахзӣк', translation: 'Вдохните глубоко и задержите дыхание', partOfSpeech: 'expression', lessonId: 0 },
      { id: 'doc_t_5', hebrew: 'תִּפְתַּח אֶת הַפֶּה וְתוֹצִיא לָשׁוֹן', hebrewPlain: 'תפתח את הפה', transcription: 'тифтáх эт hапé ветоцӣ лашóн', translation: 'Откройте рот и покажите язык', partOfSpeech: 'expression', lessonId: 0 },
      { id: 'doc_t_6', hebrew: 'תִּשְׁכַּב עַל מִטַּת הַבְּדִיקָה', hebrewPlain: 'תשכב על המיטה', transcription: 'тишкáв аль митáт hабдикá', translation: 'Ложитесь на смотровую кушетку', partOfSpeech: 'expression', lessonId: 0 },
      { id: 'doc_t_7', hebrew: 'הַאִם יֵשׁ לְךָ רְגִישׁוּת לִתְרוּפוֹת?', hebrewPlain: 'יש לך רגישות לתרופות?', transcription: 'hаим йеш лехá регишӯт литруфóт?', translation: 'У вас есть аллергия на лекарства?', partOfSpeech: 'expression', lessonId: 0 },
      { id: 'doc_t_8', hebrew: 'לָקַחְתָּ כְּבָר מַשֶּׁהוּ נֶגֶד כְּאֵבִים?', hebrewPlain: 'לקחת כבר משהו?', transcription: 'лакáхта квар мáшеhу нéгед кеэвӣм?', translation: 'Вы уже принимали что-то от боли?', partOfSpeech: 'expression', lessonId: 0 },
      { id: 'doc_t_9', hebrew: 'זֶה נִרְאֶה כְּמוֹ דַּלֶּקֶת קַלָּה', hebrewPlain: 'זה נראה כמו דלקת', transcription: 'зэ ниръé кмо далéкет калá', translation: 'Это похоже на лёгкое воспаление', partOfSpeech: 'expression', lessonId: 0 },
      ...
      { id: 'doc_t_11', hebrew: 'לָקַחַת כַּדּוּר אֶחָד פַּעֲמַיִם בְּיוֹם', hebrewPlain: 'לקחת כדור פעמיים ביום', transcription: 'лакáхат кадӯр эхáд паамáим бейóм', translation: 'Принимать одну таблетку два раза в день', partOfSpeech: 'expression', lessonId: 0 },
      ...
      { id: 'doc_t_13', hebrew: 'תִּשָּׁאֵר בַּמִּטָּה שְׁלוֹשָׁה יָמִים', hebrewPlain: 'תישאר במיטה', transcription: 'тиша’éр бамитá шлошá ямӣм', translation: 'Оставайтесь в постели три дня', partOfSpeech: 'expression', lessonId: 0 },
      { id: 'doc_t_14', hebrew: 'הִנֵּה הַפְנָיָה לִבְדִיקַת דָּם', hebrewPlain: 'הפניה לבדיקת דם', transcription: 'hинé hафная ливдикат дам', translation: 'Вот направление на анализ крови', partOfSpeech: 'expression', lessonId: 0 },
      { id: 'doc_t_15', hebrew: 'תַּחֲזֹר אֵלַי עִם הַתּוֹצָאוֹת', hebrewPlain: 'תחזור אלי עם התוצאות', transcription: 'тахзóр элáй им hатоцаóт', translation: 'Вернитесь ко мне с результатами', partOfSpeech: 'expression', lessonId: 0 },
      { id: 'doc_t_16', hebrew: 'אִם הַחֹם לֹא יוֹרֵד, תִּגַּשׁ לַמִּיּוּן', hebrewPlain: 'אם החום לא יורד', transcription: 'им hахом ло йорéд, тигáш ламиюн', translation: 'Если температура не падает, обратитесь в приёмный покой', partOfSpeech: 'expression', lessonId: 0 },
      { id: 'doc_t_17', hebrew: 'הַמַּצָּב שֶׁלְּךָ מִשְׁתַּפֵּר יָפֶה', hebrewPlain: 'המצב שלך משתפר', transcription: 'hамацáв шельхá миштапéр яфé', translation: 'Ваше состояние хорошо улучшается', partOfSpeech: 'expression', lessonId: 0 },
      ...
      { id: 'doc_t_19', hebrew: 'הַכֹּל יִהְיֶה בְּסֵדֶר, אַל תִּדְאַג', hebrewPlain: 'הכל יהיה בסדר', transcription: 'hакóль йиhйé бесéдер, аль тид’áг', translation: 'Всё будет хорошо, не переживайте', partOfSpeech: 'expression', lessonId: 0 },
      { id: 'doc_t_20', hebrew: 'רְפוּאָה שְׁלֵמָה וְתַרְגִּישׁ טוֹב!', hebrewPlain: 'רפואה שלמה!', transcription: 'рефуá шлемá ветаргӣш тов!', translation: 'Скорейшего выздоровления и поправляйтесь!', partOfSpeech: 'expression', lessonId: 0 },
      { id: 'doc_t_21', hebrew: 'אֲנִי צָרִיךְ תְּעוּדַת מַחֲלָה לָעֲבוֹדָה', hebrewPlain: 'אני צריך תעודת מחלה', transcription: 'анӣ царӣх теудáт махалá лааводá', translation: 'Мне нужна справка о болезни для работы', partOfSpeech: 'expression', lessonId: 0 },
      { id: 'doc_t_22', hebrew: 'הַתְּרוּפָה עִם אֹכֶל אוֹ עַל קֵבָה רֵיקָה?', hebrewPlain: 'התרופה עם אוכל?', transcription: 'hатруфá им óхель о аль кейвá рейкá?', translation: 'Лекарство принимать с едой или натощак?', partOfSpeech: 'expression', lessonId: 0 },
      { id: 'doc_t_23', hebrew: 'יֵשׁ לַתְּרוּפָה הַזֹּאת תּוֹפְעוֹת לְוַאי?', hebrewPlain: 'יש תופעות לוואי?', transcription: 'йеш латруфá hазóт тофеóт левáй?', translation: 'У этого лекарства есть побочные эффекты?', partOfSpeech: 'expression', lessonId: 0 },
      { id: 'doc_t_24', hebrew: 'לַחֲבֹשׁ אֶת הַפֶּצַע כָּל יוֹם', hebrewPlain: 'לחבוש את הפצע', transcription: 'лахбóш эт hапéца коль йом', translation: 'Делать перевязку раны каждый день', partOfSpeech: 'expression', lessonId: 0 },
