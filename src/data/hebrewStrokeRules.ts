...
export const HEBREW_STROKE_RULES: Record<string, LetterWritingRule> = {
  alef: {
    ...
    strokesCount: 2,
    penLifts: true,
    description: 'Рукописный Алеф пишется в два раздельных штриха (похож на латинскую букву k): сначала вертикальная прямая СЛЕВА (Штрих 1 🟢), затем дуга-петелька СПРАВА (Штрих 2 🔵).',
    startingPointSummary: 'Штрих 1: вверху слева; Штрих 2: вверху справа.',
    directionSummary: 'Штрих 1: строго сверху вниз по левой линии; Штрих 2: сверху справа дугой к центру и вниз направо.',
    proportions: {
      ascender: false,
      baseline: true,
      descender: false,
    ...
    strokes: [
      {
        id: 1,
        label: '1-й штрих: левая прямая линия (ствол k)',
        startPoint: { x: 165, y: 112 },
        path: 'M 165 112 L 165 248',
        arrow: {
          from: { x: 165, y: 125 },
          to: { x: 165, y: 225 },
        },
        instruction: 'Поставьте руку в точку 1 (вверху слева) и проведите прямую линию сверху вниз по левому краю буквы.',
      },
      {
        id: 2,
        label: '2-й штрих: правый уголок / дуга (петелька k)',
        startPoint: { x: 235, y: 145 },
        path: 'M 235 145 C 205 155 175 180 172 185 C 180 205 200 235 215 248',
        arrow: {
          from: { x: 230, y: 148 },
          to: { x: 185, y: 180 },
        },
        instruction: 'Оторвите руку. Поставьте в точку 2 (вверху справа) и очертите плавную дугу-уголок к середине левой черты и вниз направо.',
      },
    ],
  },
