...
export const HEBREW_STROKE_RULES: Record<string, LetterWritingRule> = {
  alef: {
    ...
    strokesCount: 2,
    penLifts: true,
    description: 'Рукописный Алеф пишется в два раздельных штриха (похож на латинскую букву k): сначала вертикальная прямая СЛЕВА, затем дуга-петелька СПРАВА.',
    startingPointSummary: 'Штрих 1: вверху слева; Штрих 2: вверху справа.',
    directionSummary: 'Штрих 1: строго сверху вниз слева; Штрих 2: от правого верхнего угла дугой к центру и вниз.',
    proportions: {
      ascender: false,
      baseline: true,
      descender: false,
    ...
    strokes: [
      {
        id: 1,
        label: '1-й штрих: левая вертикальная прямая (ствол)',
        startPoint: { x: 145, y: 110 },
        path: 'M 145 110 L 145 248',
        arrow: {
          from: { x: 145, y: 125 },
          to: { x: 145, y: 220 },
        },
        instruction: 'Поставьте руку в точку 1 (вверху слева) и проведите прямую вертикальную черту вниз до базовой строки.',
      },
      {
        id: 2,
        label: '2-й штрих: правая дуга-петелька',
        startPoint: { x: 225, y: 115 },
        path: 'M 225 115 C 180 120 160 165 160 180 C 160 195 185 235 220 248',
        arrow: {
          from: { x: 220, y: 120 },
          to: { x: 175, y: 165 },
        },
        instruction: 'Оторвите руку. Поставьте в точку 2 (вверху справа) и очертите плавную дугу-петельку к центру и вниз направо.',
      },
    ],
  },
