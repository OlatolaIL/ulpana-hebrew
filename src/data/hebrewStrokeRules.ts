...
export const HEBREW_STROKE_RULES: Record<string, LetterWritingRule> = {
  alef: {
    ...
    strokesCount: 2,
    penLifts: true,
    description: 'Классический рукописный Алеф пишется в два движения (по израильской школьной методике): сначала правая дуга-петелька (Штрих 1 🟢), затем левая прямая черта сверху вниз (Штрих 2 🔵).',
    startingPointSummary: 'Штрих 1: вверху справа; Штрих 2: вверху слева.',
    directionSummary: 'Штрих 1: плавная дуга справа налево к центру и вниз; Штрих 2: прямая линия сверху вниз слева.',
    proportions: {
      ascender: false,
      baseline: true,
      descender: false,
    ...
    strokes: [
      {
        id: 1,
        label: '1-й штрих: правая дуга-петелька',
        startPoint: { x: 228, y: 145 },
        path: 'M 228 145 C 195 155 174 180 172 188 C 176 208 196 235 215 248',
        instruction: 'Начните в точке 1 (вверху справа) и проведите плавную дугу-петельку к середине строки и вниз.',
      },
      {
        id: 2,
        label: '2-й штрих: левая прямая черта (ствол)',
        startPoint: { x: 166, y: 112 },
        path: 'M 166 112 C 165 155 163 205 162 248',
        instruction: 'Оторвите руку. Поставьте в точку 2 (вверху слева) и проведите прямую черту сверху вниз до базовой строки.',
      },
    ],
  },
