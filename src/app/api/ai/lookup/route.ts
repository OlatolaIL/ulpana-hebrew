...
Контекст предложения на иврите: "${context || word}".
${sentenceTranslation ? `ОФИЦИАЛЬНЫЙ РУССКИЙ ПЕРЕВОД ПРЕДЛОЖЕНИЯ: "${sentenceTranslation}".` : ''}
${sentenceTranscription ? `ОФИЦИАЛЬНАЯ РУССКАЯ ТРАНСКРИПЦИЯ ПРЕДЛОЖЕНИЯ: "${sentenceTranscription}".` : ''}
