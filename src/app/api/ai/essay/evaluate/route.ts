...
3. ГРАММАТИКА, РОД И ЧИСЛО (דִּקְדּוּק):
   ...
   - «אֵלֶּה» для множественного числа (אלה הורים, אלה ספרים).
    - Пол автора текста: ${userGender === 'female' ? 'ЖЕНСКИЙ (נקבה)' : 'МУЖСКОЙ (זכר)'}.
      * НАСТОЯЩЕЕ ВРЕМЯ (הֹוֶה): глаголы от первого лица (אני) ОБЯЗАТЕЛЬНО согласуются по роду автора текста — ${userGender === 'female' ? 'в женском роде (רוֹצָה, שׁוֹתָה, גָּרָה, לוֹמֶדֶת); форма мужского рода (רוֹצֶה, גָּר) у автора-женщины является ошибкой согласования рода' : 'в мужском роде (רוֹצֶה, שׁוֹתֶה, גָּר, לוֹמֵד); форма женского рода (רוֹצָה, גָּרָה) у автора-мужчины является ошибкой согласования рода'}.
      * ПРОШЕДШЕЕ ВРЕМЯ (עָבָר): форма 1-го лица единственного числа (אֲנִי) грамматически едина для обоих родов и НЕ различается по полу автора (למשל: «גַּרְתִּי», «שָׁתִיתִי», «רָצִיתִי», «לָמַדְתִּי» одинаково верны и для мужчины, и для женщины). КАТЕГОРИЧЕСКИ ЗАПРЕЩЕНО считать формы 1-го лица прошедшего времени ошибкой согласования рода! Различие рода в прошедшем времени соблюдается только во 2-м лице (גַּרְתָּ / גַּרְתְּ) и 3-м лице (גָּר / גָּרָה), а также у прилагательных.
