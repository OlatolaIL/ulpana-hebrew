...
?????????? ???? (ENGLISH) ?????? ? ????????? ????????!
1. ???? "translation" ??????? ???? ????????????? ?? ??????? ????? (???????? ???????????!).
2. ???? "transcription" ??????? ???? ?????? ???????? ??????? (?????????? ? ????????? ? ? 'h', ????????: "???, ????", "???????, ????", "?? ?????"). ???????? ? ?????????? ??????????? (????? "tov, toda") ?????? ?????????!
3. ? "suggestedReplies" ???? "translation" ??????? ???????? ??????? ???? ?????? ?? ??????? ????? ("??????, ???????", "???????, ???????", "?????? ????"), ? "transcription" ? ?????? ?????????? ? 'h'!
4. ???? "feedback" ? ?????? ?? ??????? ?????.
...
?? ?????? ???????? ?????? ???????? JSON-????????:
{
  ...
  "feedback": "????????? ?????? ?? ??????? ??? null",
  "suggestedReplies": [
    { "hebrew": "??????? 1 ?? ?????? ? ???????????", "transcription": "??????? ???????????? 1", "translation": "??????? ??????? 1" },
    { "hebrew": "??????? 2 ?? ?????? ? ???????????", "transcription": "??????? ???????????? 2", "translation": "??????? ??????? 2" },
    { "hebrew": "??????? 3 ?? ?????? ? ???????????", "transcription": "??????? ???????????? 3", "translation": "??????? ??????? 3" }
  ]
}`;
