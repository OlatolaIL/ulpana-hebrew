...
export const WORD_VISUAL_MAP: Record<string, WordVisualConfig> = {
  ...
  'נעים מאוד':      { openmojiHex: '1F91D', emoji: '🤝' },
  'איך קוראים לך':  { openmojiHex: '1FAAA', emoji: '🪪' },
  'קוראים לי':      { openmojiHex: '1FAAA', emoji: '🪪' },
  'מה נשמע':        { openmojiHex: '1F4AC', emoji: '💬' },
  'מה שלומך':       { openmojiHex: '1F4AC', emoji: '💬' },
  'הכל טוב':        { openmojiHex: '1F44D', emoji: '👍' },
  ...
  'יום הולדת שמח':  { openmojiHex: '1F382', emoji: '🎂' },
  'שבת שלום':       { openmojiHex: '1F56F', emoji: '🕯️' },
  ...
  // Professions & Work
  'עורך דין': { openmojiHex: '2696',  emoji: '⚖️' },
  'מהנדס':    { openmojiHex: '1F4D0', emoji: '📐' },
  'טבח':      { openmojiHex: '1F9D1-1F373', emoji: '🧑‍🍳' },
  'נהג':      { openmojiHex: '1F68C', emoji: '🚌' },
  'מוכר':     { openmojiHex: '1F6D2', emoji: '🛍️' },
  'מנהל':     { openmojiHex: '1F4CA', emoji: '📊' },
  'שחקן':     { openmojiHex: '1F3AD', emoji: '🎭' },
  'שוטר':     { openmojiHex: '1F46E', emoji: '👮' },
  'זמר':      { openmojiHex: '1F3A4', emoji: '🎤' },
  'סופר':     { openmojiHex: '270D',  emoji: '✍️' },

  // Body & Health
  'ראש':      { openmojiHex: '1F9E0', emoji: '🧠' },
  'יד':       { openmojiHex: '270B',  emoji: '✋' },
  'רגל':      { openmojiHex: '1F9B5', emoji: '🦵' },
  'עין':      { openmojiHex: '1F441', emoji: '👁️' },
  'אוזן':     { openmojiHex: '1F442', emoji: '👂' },
  'לב':       { openmojiHex: '2764',  emoji: '❤️' },
  'שיניים':   { openmojiHex: '1F9B7', emoji: '🦷' },
  'שן':       { openmojiHex: '1F9B7', emoji: '🦷' },
  'בטן':      { openmojiHex: '1F930', emoji: '🤰' },
  'תרופה':    { openmojiHex: '1F48A', emoji: '💊' },
  'חום':      { openmojiHex: '1F321', emoji: '🌡️' },

  // Weather & Nature
  'שמש':      { openmojiHex: '2600',  emoji: '☀️' },
  'גשם':      { openmojiHex: '1F327', emoji: '🌧️' },
  'שלג':      { openmojiHex: '2744',  emoji: '❄️' },
  'רוח':      { openmojiHex: '1F4A8', emoji: '💨' },
  'ענן':      { openmojiHex: '2601',  emoji: '☁️' },
  'חם':       { openmojiHex: '1F525', emoji: '🔥' },
  'קר':       { openmojiHex: '1F9CA', emoji: '🧊' },
  'עץ':       { openmojiHex: '1F333', emoji: '🌳' },
  'פרח':      { openmojiHex: '1F338', emoji: '🌸' },
  'הר':       { openmojiHex: '26F0',  emoji: '⛰️' },

  // Home & Apartment
  'מטבח':     { openmojiHex: '1F373', emoji: '🍳' },
  'סלון':     { openmojiHex: '1F6CB', emoji: '🛋️' },
  'שירותים':  { openmojiHex: '1F6BD', emoji: '🚻' },
  'אמבטיה':   { openmojiHex: '1F6C1', emoji: '🛁' },
  'מרפסת':    { openmojiHex: '1FAB4', emoji: '🪴' },
  'חוזה':     { openmojiHex: '1F4C3', emoji: '📑' },
  'שכר דירה': { openmojiHex: '1F4B0', emoji: '💰' },
};
