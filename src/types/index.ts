...
export type ThematicDeckCategory =
  ...
  | 'librarian'   // ספרן וארכיונאי — библиотекарь, архивариус и архивные службы
  | 'carWash'     // רחיצת רכב ושטיפה — автомойка, уход за автомобилем и детейлинг
  | 'mom'         // מקצוע: אמא — материнство, здоровье детей, садики и школа в Израиле
  | 'other';
